---
tipas: zodyno_irasas
pavadinimas: 'priverstinė komercializacija'
saltiniai:
...
- id: c-186246
  ...
  citata_originali: |
    ...
    (pvz., grūdų) kaina krisdavo, ir stengda­
    vosi parduoti mažiau, kai produkto kaina
    kilo, kad turėtų atsargų nuolat pasikarto­
    jančiais nederliaus metais. Tokio pobūdžio
    „priverstinė komercializacija“ buvo antro­
    ji valstiečio dvisektorio ūkio pusė59. Tai
