---
tipas: zodyno_irasas
pavadinimas: 'Kauno svečių teisė'
saltiniai:
...
- id: c-185153
  ...
  citata_originali: |
    Kauno suolininkas Martynas Slaveckis skundėsi Kauno vaitui, kad upėje palikta į
    Aleksotą neiškelta Henriko Bantkės vytinė, potvynio metu upės nešama, nevaldoma
    sugriovė dalį Nemuno krantinės.
    Kauno prekybos teisinis reglamentavimas. Vienas iš svarbiausių šios srities pasieki-
    mų buvo Kauno svečių teisės, įskaitant sankrovos teisę, susiformavimas.
  statusas: verified
  atnaujinta: "2026-07-19 10:18"
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
