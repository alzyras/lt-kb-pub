...
- id: c-168714
  ...
  citata_originali: |
    ...
    skubiausiai pasitraukė, išsivarydami grobį. Po to jie
    pamėgino pulti Gardino ir
    A p g in a m o s
    G ardin o
    Bisenės pilis: pastarąją už-
    ir B isen ės p ily s
...
- id: c-168715
  ...
  indeksas: "Albertas Vijūkas-Kojelavičius, Lietuvos istorija (1989 m.)."
  citata_originali: |
    Galop nuvedė karius siaubti
    valdų to kryžiuočio, kuris neseniai mūšyje jį buvo
    numetęs nuo arklio; Kekerbergo vardu šaukiamą pilį
    užkariavo, apiplėšė ir sudegino kartu su paimtaisiais į
    nelaisvę kariais. Džiaugėsi Kęstutis, kad atsikeršijo, ir
