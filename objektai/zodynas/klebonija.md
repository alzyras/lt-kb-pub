...
- t-001
  ...
  sudarymo_pagrindimas: 'Reikia aiškiai įvardyti kleboniją ir pašalinti neaiškų įvardį.'
  susije_objektai: 'mentioned_object: [[objektai/zodynas/Sanctuarium|Sanctuarium]]; mentioned_object: [[objektai/zodynas/fundacija|fundacija]]; mentioned_person: [[objektai/asmenys/Bona|Bona]]; mentioned_person: [[objektai/asmenys/Vladislovas IV|Vladislovas IV]]; mentioned_place: Kražiai; mentioned_place: Viena'
  pagrindžia:
    - c-003
  ...
  ryšio_subjekto_parinkimas: klebonija: owner_note_path, thing, gap=0
  ryšio_targeto_parinkimas: Bona: mention_match, person, gap=54
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "klebonija" parinktas kaip owner_note_path. Targetas "Bona" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, same_sentence_locality.
...
- t-002
  ...
  sudarymo_pagrindimas: 'Fragmentas išplėstas į pilną faktinį sakinį pagal citatą.'
  susije_objektai: 'mentioned_person: [[objektai/asmenys/Jogaila|Jogaila]]; mentioned_person: [[objektai/asmenys/Martynas iš Golino|Martynas iš Golino]]; mentioned_person: [[objektai/asmenys/Vladislovas Jogaila|Vladislovas Jogaila]]; mentioned_place: Viena; mentioned_place: Vilnius; llm_object: Vilnius'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
...
- t-003
  ...
  sudarymo_pagrindimas: 'Pradinis tekstas sumaišytas su išnašomis, citata palaiko sutvarkytą sakinį.'
  susije_objektai: 'mentioned_place: Gniezno; mentioned_person: [[objektai/asmenys/Tomas (Hertvigo iš Pokarvių sūnus)|Tomas (Hertvigo iš Pokarvių sūnus)]]; mentioned_place: Brasta; mentioned_place: Dubnas; mentioned_place: Klodovas; mentioned_place: Tauragnai; mentioned_place: Verkiai; mentioned_place: Vilniaus katedra; mentioned_place: Vilnius'
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
  saltinio_vieta: 246091-246272; hash=ff7edbcbd308ee80fbf833cbaec3b31cce06ae639b57917f86c443009750b3b1; match=whitespace_regex
  sprendimo_priezastis: auto
  ryšio_patikimumas: pastate -> Vilnius: 0.63
  ryšio_patikimumo_lygis: vidutinis
  ryšio_patikimumo_priezastys: llm_structured_decision; deterministic_validation_passed
  ryšio_sprendimo_taisykle: llm_validated_relation
  ryšio_subjekto_parinkimas: Vladislovas Jogaila: llm_allowed_candidate, person
  ryšio_targeto_parinkimas: Vilnius: llm_allowed_candidate, place
  ryšio_paaiskinimas: Citata tiesiogiai sako, kad Vladislovas Jogaila įsakė statyti Vilniuje; tinkamesnio bažnyčios objekto tarp kandidatų nėra, todėl ryšys fiksuojamas su statybos vieta.
...
- c-002
  ...
  pagrindžia:
    - t-003
- c-003
  santrauka: 'Karalienė Bona ir Vladislovas IV taip gausiai apdovanojo Kražių kleboniją turtais, kad ji tapo reikšmingiausia Žemaitijoje.'
  šaltinis: Michał Baliński, Vilniaus miesto istorija (2007 m.)
  citata_originali: |
    Pats miestelis dali­
