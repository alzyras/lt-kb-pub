...
Nuorašas šiame leidinyje reiškia rankraštinę teksto kopiją, kuria plito Lietuvos metraštinė literatūra. Terminas vartojamas ir tekstų sklaidai, ir konkrečių rankraščių tekstologiniams santykiams bei kilmei nusakyti.

## Žodis ir formos

- Pagrindinė forma: nuorašas.
- Vartojamos formos: nuorašas, nuorašų, nuorašais.

## Laikotarpis ir datos

- laikotarpis: XVI a.; XVIII a. vidurys; XX a. pradžia.
- amziai: XVI, XVIII, XX.

## Reikšmė iš konteksto

Terminas nusako rankraštinę teksto kopiją, per kurią tekstai buvo perrašinėjami, plito ir lyginami tarpusavyje.

## Vartojimas

Žodis vartojamas kalbant apie rankraštinę sklaidą, papildomų nuorašų radimą Vilniuje ir Bychovco kronikos rankraščio santykį su ankstesne kopija.
...
- t-001
  ...
  sudarymo_pagrindimas: 'Teiginys yra aiškus sakinys apie Bychovco kronikos rankraščio nuorašą ir tiksliai remiasi citata. Sąmoningai neįtraukiamos papildomos detalės apie spragas ir iškraipymus.'
...
- t-004
  ...
  sudarymo_pagrindimas: 'Teiginys aiškiai susieja metraštinės literatūros sąvadus su rankraštiniais nuorašais ir skaičiumi. Nepridėta leidinių publikavimo istorijos už citatos ribų.'
  susije_objektai: 'mentioned_group: [[objektai/grupes/Rusai|Rusai]]; mentioned_object: [[objektai/zodynas/sąvadas|sąvadas]]; mentioned_place: Lietuva; mentioned_place: Rusija'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
