...
- id: c-186360
  ...
  citata_originali: |
    ...
    žmonės LDK įstatymuose prilyginti valkatoms. Pastarieji
    minimi kartu su laisvaisiais žmonėmis, laisvaisiais samdi­
...
- id: c-186361
  ...
  citata_originali: |
    ...
    Prieš šią grupę nukreiptos represinės priemonės byloja, kad
    dėl savo gyvenimo būdo ji daugelį amžių buvo laikoma
    pavojinga, maištaujanti prieš socialinę tvarką". 1468 m.
    Kazimiero teisyno 8 straipsnyje nustatyta, kad valkatos nu­
    sikaltimu padarytą žalą turi atlyginti tas, kuris jį yra slaptai
