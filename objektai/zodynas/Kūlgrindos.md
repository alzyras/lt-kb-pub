...
## Vartojimas
Terminas šaltinyje vartojamas šiame kontekste: gynyba, susisiekimas, senoji vietinė terminija. (t-001)
...
- id: q-001
  santrauka: Taip vadinami žemaičių akmenimis grįsti slaptieji keliai per upes, ežerus ir pelkes.
  šaltinis: [[A. Šapoka (red.), Lietuvos istorija (1936 m.)]]
  citata_originali: |
    Tuo būdu kartais, kai nebebūdavo
    vilties išsigelbėti, pilies įgula galėjo iš apgultos pilies slapta per-
    sikelti į gretimą pilį. Tie slaptieji keliai dažniausiai eidavo per
    upes, ežerus ar neišklampojamas pelkes, kur po vandeniu bū-
    davo išgrindžiami akmens ar rąstų keliai. Tie keliai būdavo tokie
