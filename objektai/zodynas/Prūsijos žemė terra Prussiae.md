---
tipas: zodyno_irasas
pavadinimas: 'Prūsijos žemė terra Prussiae'
saltiniai:
...
media_all_json: |-
  []
---
# Prūsijos žemė terra Prussiae

## Santrauka

Dusburgietis teigia, kad petro iš Dusburgo kronikoje visa Prūsijos žemė (terra Prussiae) skirstoma į 11 dalių, atskirų žemių. Dusburgietis teigia, kad tyrimai parodė, kad jos autorius (visų pirma politine prasme) Prūsijos, prūsų vardu vadino visą Kryžiuočių ordino jau užkariautą, į Ordino valstybę patekusį plotą nuo Vyslos iki Nemuno.
...
- t-002
  ...
  ryšio_paaiskinimas: "Citata tiesiogiai nurodo, kad Kulmo sritis anksčiau priklausė lenkams."
  pagrindžia:
    - c-59552
...
- t-001
  ...
  ryšio_paaiskinimas: "Citata Prūsijos vardu vadinamą plotą apibūdina kaip Kryžiuočių ordino užkariautą."
  pagrindžia:
    - c-59553

<a id="claim-t-184018"></a>
- t-003
  global_id: t-184018
  teiginys: "Petro iš Dusburgo kronikoje visa Prūsijos žemė (terra Prussiae) skirstoma į vienuolika atskirų žemių."
  ...
  ryšio_subjekto_parinkimas: "Prūsijos žemė terra Prussiae: owner_note_path, thing, gap=0"
  ryšio_targeto_parinkimas: "Prūsija: mention_match, place, gap=0"
  ryšio_paaiskinimas: "Ryšys sukurtas taisykle \"rule_plain_mention\". Subjektas \"Prūsijos žemė terra Prussiae\" parinktas kaip owner_note_path. Targetas \"Prūsija\" parinktas kaip mention_match aplink predikatą \"mention\". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality."
  pagrindžia:
    - c-167403

<a id="claim-t-184019"></a>
- t-004
  global_id: t-184019
  teiginys: "Tyrimų duomenimis, Petras Dusburgietis Prūsija vadino Ordino užkariautą plotą nuo Vyslos iki Nemuno."
  teiginio_tipas: "saltinio_teiginys"
  ...
  ryšio_subjekto_parinkimas: "Kulmas: llm_allowed_candidate, place"
  ryšio_targeto_parinkimas: "Lenkai: llm_allowed_candidate, group"
  ryšio_paaiskinimas: "Citata aiškiai teigia ankstesnį Kulmo srities priklausymą lenkams."
  pagrindžia:
    - c-167404
