...
- id: c-184545
  ...
  citata_originali: |
    ...
    riaudamas su padaugėniais netikėliais, kaip jau mi-
    navojau. Darau dingterėjo v. Kristijonui į širdį
    pavėdų zokaną, arba brostvą, Paysly įkurti dėl už­
    tarymo tenai naujos bažnyčios ir gelbėjimo ūkės
...
- id: c-184546
  ...
  citata_originali: |
    ...
    klauso, nuo kitų visų vyresnybių yra liuosais. Ne-
    kakinos Aleksandras IV padauginęs jų skaitlių,
    bet dar norėjo juos pagodinti, iškeikdamas visus
    tuos, kurie drįstų zokanyką kryžėją abydyti ar už­
    tikti. Ant galo padidino jų patį iždą, nes vien lie-
    cybas pirmųjų popiežių patvirtindamas, bet dar
    leisdamas jiems visur prekioti o iškeikdamas visus
