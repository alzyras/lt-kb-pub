...
- id: c-185120
  ...
  citata_originali: |
    Žygimantas Augustas paskelbė, kad visoje valstybėje pastočių
    (pervežimo paslaugų) prievolė keičiama į piniginį mokestį, ir išsiuntinėjo šio mokes-
    čio mokėtojams raginimus jį mokėti, Kauno miesto vaitas ir miestiečiai kreipėsi į val-
    dovą įrodinėdami, kad Kauno miestas, besinaudojąs tokiomis pat laisvėmis ir Mag-
    deburgo teise, kaip ir Vilniaus miestas, niekada pastočių prievolės atlikti neprivalėjo.
