...
- id: c-184533
  ...
  citata_originali: |
    ...
    gelbėti, dariu ėmė su lietuviais sandarauti. Lietu­
    viai ant to sutiko, bet reikalavo už vadą paties mar-
    čelgos ir trijų brostvių, kamendotas Baigos, arba
    Onedos, nenorėjo to daryti, tardamas geresniai į
...
- id: c-184534
  ...
  citata_originali: |
    ...
    galą, atėjo vėl su stipria kariauna griautis ir pilį
    ardyti, vienok įgulė didžiai kantriai gynės, kuri
    daug lietuvių ir žemaičių karda ir vylyčiomis atlai­
    kė. Nes, besigrumiant su lietuviais, krito kamendo-
    tas įgulės, kuri, nustojusi karvedžio, pradėjo gurti,
    o lietuviai kuo narsesniai laužtis, ant galo įsigrūdo
    į pilį ir visa, kas tenai gyvu buvo, nugalavo, o pilį
    sudegino. Metus sukakus, antroj pusėj Osos ant
...
- id: c-184535
  ...
  citata_originali: |
    ...
    kas metą dėl pataisymo to konvento 100 svarų si­
    dabro duoklės jiems mokės. Tarp vyresniųjų pilės
    pusė turės būti brostvių, antra pusė ūkinykų, o ka-
    mendotas konvento tiesos suole sėdėti ir spręsti ly­
    giai su kitais pilės teisdariais galės. Pilionys ant galo
