...
- t-001
  ...
  susije_objektai: 'mentioned_object: [[objektai/zodynas/konstitucijos|konstitucijos]]; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_place: Baltija; mentioned_place: SSRS'
  ...
  ryšio_subjekto_parinkimas: Konstitucijos pataisos dėl LKP valdžios monopolio panaikinimo: owner_note_path, source, gap=0
  ryšio_targeto_parinkimas: konstitucijos: mention_match, thing, gap=0
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Konstitucijos pataisos dėl LKP valdžios monopolio panaikinimo" parinktas kaip owner_note_path. Targetas "konstitucijos" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
