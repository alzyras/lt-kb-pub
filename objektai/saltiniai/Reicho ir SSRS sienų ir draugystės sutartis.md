---
tipas: saltinis
pavadinimas: 'Reicho ir SSRS sienų ir draugystės sutartis'
saltiniai:
...
amziai:
  - 'XX'
---
# Reicho ir SSRS sienų ir draugystės sutartis
...
- t-001
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Lietuvos kariuomenė|Lietuvos kariuomenė]]; mentioned_place: Lietuva; mentioned_place: SSRS; mentioned_person: [[objektai/asmenys/Joachimas (Pskovo vietininkas)|Joachimas (Pskovo vietininkas)]]; mentioned_place: Liublinas; mentioned_place: Vokietija'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=cda34d05003c854e22e0e31a4d1edfd41534939b60f2977d01ff76597cc8339d; match=fallback; occurrences=0
  sprendimo_priezastis: auto
  ryšio_patikimumas: susije_su -> Lietuva: 0.85
  ryšio_patikimumo_lygis: vidutinis
  ryšio_patikimumo_priezastys: owner_before_predicate; single_candidate_target; single_candidate_actor; target_after_predicate; same_sentence_locality
  ryšio_sprendimo_taisykle: rule_plain_mention
  ryšio_subjekto_parinkimas: Reicho ir SSRS sienų ir draugystės sutartis: owner_note_path, source, gap=0
  ryšio_targeto_parinkimas: Lietuva: mention_match, place, gap=75
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Reicho ir SSRS sienų ir draugystės sutartis" parinktas kaip owner_note_path. Targetas "Lietuva" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
...
- t-002
  ...
  sudarymo_pagrindimas: 'Pradinė formuluotė nukrypsta nuo šaltinio objekto, o citata tiesiogiai pagrindžia sutarties slaptą protokolą.'
  susije_objektai: 'mentioned_group: [[objektai/grupes/Lietuvos kariuomenė|Lietuvos kariuomenė]]; mentioned_place: Lietuva; mentioned_place: SSRS; mentioned_person: [[objektai/asmenys/Joachimas (Pskovo vietininkas)|Joachimas (Pskovo vietininkas)]]; mentioned_place: Liublinas; mentioned_place: Maskva; mentioned_place: Vokietija'
  temporaliniai_duomenys: 'įvykio data: 1939 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
  temporalinis_llm_pakomentavimas: 'Pradinė formuluotė nukrypsta nuo šaltinio objekto, o citata tiesiogiai pagrindžia sutarties slaptą protokolą.'
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
