---
tipas: saltinis
pavadinimas: 'Ostrovo sutartis (1392 m.)'
sukurta: '2026-05-05'
variantai:
  - 'Ostrovo sutartim'
  - 'Ostrovos sutartimi (1392)'
  - 'Ostrovos sutarties'
aliases: []
saltiniai:
...
Ostrovo sutartimi Jogaila atidavė Vytautui valdyti visą didžiąją Lietuvos kunigaikštiją su rusiškąja jos dalimi, o Vytautas su Ona pažadėjo Jogailai ir Lenkijos karūnai ištikimybę. Šiame veikale sutartis taip pat įvardijama kaip pagrindas Lietuvos nepriklausomybei atstatyti ir krašto taikai bei tvarkai užtikrinti.

## Bibliografiniai duomenys

- Šaltinio pobūdis: sutartis.
- Data / laikotarpis: 1392 m.
...
- t-004
  ...
  statusas: patvirtinta
- t-005
  teiginys: 'Ostrovo sutartim atidavė jis Vytautui valdyti visą didžiąją Lietuvos kunigaikštiją su rusiš- (^1) ) Scr.'
  pagrindžia:
    - c-003
- t-006
...
- c-003
  santrauka: 'Ostrovo sutartim atidavė jis Vytautui valdyti visą didžiąją Lietuvos kunigaikštiją su rusiš- (^1) ) Scr.'
  šaltinis: Vytautas Didysis 1350-1430 (1930 m.)
  citata_originali: |
...
- c-004
  ...
  citata_originali: |
    ...
    tvarką išvargintam ir nualintam ilgų naminių karų kraštui. Jo­
    gailai išėjus į Lenkiją, tvarka viduje dar labiau pašlijo, nes jo
    paskirti visoki seniūnai lenkai ir Skirgaila sukėlė krašte tik dar
    didesnį nepasitenkinimą ir bruzdėjimą; sričių kunigaikščiai ėmė
    nebeklausyti Jogailos ir atsimesti nuo Lietuvos.
  citata_rodoma: ''
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
  patikimumo_saltinis: ai
