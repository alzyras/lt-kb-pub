---
tipas: saltinis
pavadinimas: 'Karaliaus ir Vytauto sutartis su kryžiuočiais Racionže (1404 m.)'
saltiniai:
...
Racionže Jogaila, Vytautas ir magistras Jungingenas susitiko svarstyti taikos tarp Jogailos ir kryžiuočių. Racionžo sutartyje Vytautas turėjo užleisti kryžiuočiams Žemaitiją, Jogaila sumokėti 40 tūkst. florinų, o kryžiuočiai atiduoti lenkams Dobrynę. Kojelavičiaus pasakojime kryžiuočiai per Švitrigailos antrą pabėgimą į Prūsiją baisiai nusiaubė Lietuvą.
...
- t-002
  ...
  ryšio_subjekto_parinkimas: "Karaliaus ir Vytauto sutartis su kryžiuočiais Racionže (1404 m.): owner_note_path, source, gap=0"
...
- c-001
  ...
  citata_originali: |
    Iš druskos kasyklų jis kasmet gaudavo tūkstantį
    penkis šimtus lenkų markių pajamų. Turėjo nemažą tė­
    voniją, prilygstančią didelei kunigaikštystei, bet tam,
    kas labai daug nori, visuomet visko maža.
    Taigi ir jis antrą kartą
    K ry žiu o č ia i n io k o ja
    perėjo į Prūsiją, norėdamas
    L ietu vą
    kryžiuočių padedamas užpulti
    Lietuvos kunigaikštystę. Tuo
...
- c-002
  ...
  citata_originali: |
    ...
    Jungingenas. Kryžiuočiai kėlė galybę visokiausių rei­
    kalavimų, dėl kurių, be abe-
    1404 m e ta i
    jonės, būtų nutrukusios prasi-
    N a u ja karaliau s
    b e i
    dėjusios derybos, jeigu būti-
    V y ta u to
    su tartis
    su
    nybė nebūtų skatinusi tauriai
    k ry žiu o č ia is
    tvardytis daugiau, nei, rodos,
    įmanoma. Mat Vytautas, gal
