---
tipas: paprotys
pavadinimas: 'Aisčių medžių ir girių garbinimas'
sukurta: '2026-04-24'
variantai: []
aliases: []
saltiniai:
...
laikotarpis: 'senovės aisčiai; senieji kalnėnai ir žemaičiai'
datos:
  - 'senovės aisčiai'
  - 'senieji kalnėnai ir žemaičiai'
periodas: 'senove'
periodo_grupes: []
amziai: []
date_start: ''
...
- c-002
  ...
  citata_originali: |
    ...
    pasauses tiktai namų medžiagai ir padarynei tekirto, o sankritomis ir sausšakėmis namuose
    šildės; ir taip, juo naudingesnis medis žmogaus gyvenimui buvo, juo didžiau jį saugojo, ne vien
...
- c-003
  ...
  citata_originali: |
    ...
    nuomonę reikėjo šventą ugnį tuoįtimpos^168 ant dievo garbės kūrinti iki pabangos^169 šio pasaulio,
    todėl ąžuolus kirsti, kaipo šventus medžius, patys kunigai šventais kirviais tegalėjo. Ne vien buvo
