---
tipas: paprotys
pavadinimas: 'Religinė procesija per Sekmines'
saltiniai:
...
media_all_json: |-
  []
---
# Religinė procesija per Sekmines

## Santrauka

Šaltinis mini, kad per Sekmines (birželio 6) Lenčicos bažnyčios kanauninkai, kunigai ir kiti dvasininkai, apsivilkę iškilmių arnotais, ėjo procesiją.
...
<a id="claim-t-225174"></a>
- t-001
  teiginys: "Šaltinis mini, kad per Sekmines (birželio 6) Lenčicos bažnyčios kanauninkai, kunigai ir kiti dvasininkai, apsivilkę iškilmių arnotais, ėjo procesiją."
