---
tipas: paprotys
pavadinimas: 'Tikėjimo vertimas kaip politinio spaudimo priemonė'
saltiniai:
...
media_all_json: |-
  []
---
# Tikėjimo vertimas kaip politinio spaudimo priemonė

## Santrauka

Ogi Skir gaila nėra mūsų 2 krikščionių tikėjimo, jis yra rusų tikėjimo3 , kurio ir šiandien laikosi. Ir taip aš ir šiandien laikausi krikščionių tikėjimo.
...
- c-001
  santrauka: 'Ogi Skir gaila nėra mūsų 2 krikščionių tikėjimo, jis yra rusų tikėjimo3 , kurio ir šiandien laikosi.'
...
- c-002
  santrauka: 'Ir taip aš ir šiandien laikausi krikščionių tikėjimo.'
  šaltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
  citata_originali: |
    ...
    tikėjimo. Jie ir vėl nenorėjo man leisti kitaip tikėti.
