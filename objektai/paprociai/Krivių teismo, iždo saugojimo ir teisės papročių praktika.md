---
tipas: paprotys
pavadinimas: 'Krivių teismo, iždo saugojimo ir teisės papročių praktika'
saltiniai:
...
media_all_json: |-
  []
---
# Krivių teismo, iždo saugojimo ir teisės papročių praktika

## Santrauka

Religija suteikdavo kriviams valdžią tam tikroje apygardoje, apskrityje arba vėliavoje; jam buvo paval dūs visi žemesnieji kunigai.
...
- id: c-177209
  ...
  citata_originali: |
    ...
    vūlę apsiuntinėjus, neišdrįsta pasilikti namuose“. Iš to imta
    spėlioti, kad krivuliai (Krywule) iš tikrųjų nebuvę žmonės, o
    tas ženklas davęs dingstį sukurti juos kronikose. Mokančiam
    slavų kalbą sunku su tuo sutikti, kadangi šis žodis tiesiai ir
    paraidžiui paimtas iš tos kalbos, o kartu jis negalėjo duoti var­
    do pareigoms, kurių slavai visiškai nežinojo. Taigi čia aiškus
