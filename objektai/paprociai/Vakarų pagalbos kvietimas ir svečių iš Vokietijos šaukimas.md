---
tipas: paprotys
pavadinimas: 'Vakarų pagalbos kvietimas ir svečių iš Vokietijos šaukimas'
saltiniai:
...
- t-003
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Aisčiai|Aisčiai]]; mentioned_group: [[objektai/grupes/Kryžiuočių ordinas|Kryžiuočių ordinas]]; mentioned_object: [[objektai/daiktai/Kryžius|Kryžius]]; mentioned_place: Palestina'
  pagrindžia:
    - c-002
...
- t-004
  ...
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Kryžius|Kryžius]]; mentioned_place: Livonija; mentioned_place: Prūsų žemė'
  pagrindžia:
    - c-003
