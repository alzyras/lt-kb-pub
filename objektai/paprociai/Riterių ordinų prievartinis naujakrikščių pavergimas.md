---
tipas: paprotys
pavadinimas: 'Riterių ordinų prievartinis naujakrikščių pavergimas'
saltiniai:
...
media_all_json: |-
  []
---
# Riterių ordinų prievartinis naujakrikščių pavergimas
...
- id: c-187815
  ...
  citata_originali: |
    ...
    jau buvo atversti į tikrąjį tikėjimą ir tik laukė kunigo su
    šlakstykle. Jie to imdavosi kartais tam, kad vyskupams
    nemalonumų pridarytų, kitais kartais tam, kad nuslopin­
    tų visokį pagonių tikėjimą anų pažadais ir primestų nuo­
    monę, esą visiems krikščionims svetimas garbingas elge­
    sys, žmoniškumas ir tvirtas pažadas, jog jie žmones en-
    gią tik tam, kad engtų ir patenkintų savo godumą. Jie
