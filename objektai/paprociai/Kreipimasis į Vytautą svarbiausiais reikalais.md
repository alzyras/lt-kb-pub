---
tipas: paprotys
pavadinimas: 'Kreipimasis į Vytautą svarbiausiais reikalais'
saltiniai:
...
Iš anų laikų lenkų karūnos kanceliarijos raštų matome, kad to meto žymūs politikai: pakancleriai, vyskupai, senatoriai kreip­ davosi į Vytautą svarbiausiais karūnos reikalais, prašydami pa­ tarimo, dažniausiai jo paramos. Žodžiu, visur Vytautas buvo reikalingas, pageidaujamas ir laukiamas.
...
- t-001
  ...
  ryšio_subjekto_parinkimas: Kreipimasis į Vytautą svarbiausiais reikalais: owner_note_path, thing, gap=0
  ryšio_targeto_parinkimas: Karūna: mention_match, thing, gap=24
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Kreipimasis į Vytautą svarbiausiais reikalais" parinktas kaip owner_note_path. Targetas "Karūna" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
...
- t-002
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Bajorai|Bajorai]]; mentioned_group: [[objektai/grupes/Lenkai|Lenkai]]; mentioned_place: Červinskas; mentioned_object: [[objektai/daiktai/Karūna|Karūna]]'
  pagrindžia:
    - c-002
...
- t-003
  ...
  sudarymo_pagrindimas: 'Pirminis tekstas buvo fragmentiškas; citata leidžia suformuluoti pilną faktą.'
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Karūna|Karūna]]; mentioned_group: [[objektai/grupes/Lenkai|Lenkai]]; mentioned_object: [[objektai/zodynas/pakancleris|pakancleris]]; mentioned_person: [[objektai/asmenys/Stanislovas Ciołek|Stanislovas Ciołek]]; mentioned_person: [[objektai/asmenys/Ziemovitas|Ziemovitas]]; mentioned_place: Płockas'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
