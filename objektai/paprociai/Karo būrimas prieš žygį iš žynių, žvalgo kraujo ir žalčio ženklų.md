---
tipas: paprotys
pavadinimas: 'Karo būrimas prieš žygį iš žynių, žvalgo kraujo ir žalčio ženklų'
sukurta: '2026-04-30'
variantai: []
aliases: []
saltiniai:
...
Prieš pradėdami karą senovės kalnėnai ir žemaičiai pirmiausia klausdavo žynių apie būsimą laimę. Traukiant į karę žalčio pasirodymas kelyje buvo laikomas laimės ženklu.
...
- c-002
  ...
  pagrindžia:
    - t-004
- c-003
  santrauka: '- pagrindzia: - pastaba: Išsaugota kaip atskiras galimo teiginio įrodymas prieš viešą publikavimą.'
  šaltinis: Simonas Daukantas, Būdas senovės lietuvių, kalnėnų ir žemaičių.clean
  citata_originali: |
    - public_note:
