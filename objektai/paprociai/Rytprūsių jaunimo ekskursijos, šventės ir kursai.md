---
tipas: paprotys
pavadinimas: "Rytprūsių jaunimo ekskursijos, šventės ir kursai"
sukurta: "2026-04-18"
variantai: 
...
- id: q-001
  ...
  šaltinis: [[A. Šapoka (red.), Lietuvos istorija (1936 m.)]]
  citata_originali: |
    Į Rytprūsius iš visos Vokietijos daromos jaunimo ekskursijos; čia taip pat organi-
    zuojamos įvairios šventės ir kursai, kurių metu stengiamasi įkalti
    vokiečių jaunimui, kad jų tautos uždavinys — valdyti Rytus.
  citata_rodoma: |
    Į Rytprūsius iš visos Vokietijos daromos jaunimo ekskursijos; čia taip pat organizuojamos įvairios šventės ir kursai, kurių metu stengiamasi įkalti vokiečių jaunimui, kad jų tautos uždavinys — valdyti Rytus.
