---
tipas: paprotys
pavadinimas: 'Naktinis faraono lošimas per vizitus'
saltiniai:
...
media_all_json: |-
  []
---
# Naktinis faraono lošimas per vizitus
...
- kas atlieka: Vilniuje apsistoję didikai ir jų aplinka.
- kada atliekama: tarpusavio vizitų metu.
- kaip atliekama: dažnai lankantis vieniems pas kitus ir per naktį lošiant faraoną.

## Paskirtis

Lošimas veikė kaip aukštuomenės bendravimo ir laisvalaikio forma.
