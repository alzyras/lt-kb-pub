---
tipas: paprotys
pavadinimas: 'Žynio sapno aiškinimas ir aukojimas prieš miesto statybą'
saltiniai:
...
tags:
  ...
  - pilis
---
# Žynio sapno aiškinimas ir aukojimas prieš miesto statybą

## Santrauka

Toks šio sapno aiškinimas turėjo Gediminui būti vada, Dievui au­ kas sudėjus, ant Tauro kalno pastatydinti Aukštutinę mūro pilį, o kitą - kalno papėdėje, slėnyje, - medinę, kurią pavadi­ no Vilniumi pagal Vilnios upės vardą.
...
- t-001
  ...
  susije_objektai: 'llm_object: Aukštutinė pilis; mentioned_person: [[objektai/asmenys/Gediminas|Gediminas]]; mentioned_place: Aukštutinė pilis; mentioned_place: Vilniaus Aukštutinė pilis; mentioned_place: Vilnius; mentioned_person: [[objektai/asmenys/Lizdeika|Lizdeika]]; mentioned_place: Luckas; mentioned_place: Vengrija'
  pagrindžia:
    - c-001
