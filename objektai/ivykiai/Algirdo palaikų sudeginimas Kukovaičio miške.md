...
- t-001
  ...
  ryšio_subjekto_parinkimas: Algirdo palaikų sudeginimas Kukovaičio miške: owner_note_path, event, gap=0
  ryšio_targeto_parinkimas: Algirdas (Lietuvos valdovas): mention_match, person, gap=67
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Algirdo palaikų sudeginimas Kukovaičio miške" parinktas kaip owner_note_path. Targetas "Algirdas (Lietuvos valdovas)" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
