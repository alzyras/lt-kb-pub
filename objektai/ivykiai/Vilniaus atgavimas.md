---
tipas: ivykis
pavadinimas: "Vilniaus atgavimas"
sukurta: "2026-04-20"
variantai: []
aliases: []
saltiniai: 
...
laikotarpis: "1920 m. liepos 15 d. – rugpiūčio mėn. pabaiga"
datos: 
  - "1920 m. liepos 15 d. – rugpiūčio mėn. pabaiga"
periodas: ""
periodo_grupes: []
amziai: 
  - "XX"
...
Lietuvių pulkai įžengė į Vilnių, o iki rugpiūčio pabaigos į sostinę persikėlė ir valstybės įstaigos. (t-001)

## Laikotarpis ir datos

- laikotarpis: 1920 m. liepos 15 d. – rugpiūčio mėn. pabaiga (t-001)
- datos: 1920 m. liepos 15 d. – rugpiūčio mėn. pabaiga (t-001)
- amziai: XX (t-001)
...
- t-001
  teiginys: "Lietuvių pulkai įžengė į Vilnių, o iki rugpiūčio pabaigos į sostinę persikėlė ir valstybės įstaigos."
  pagrindžia:
    - c-001
...
- c-001
  santrauka: Lietuvių pulkai įžengė į Vilnių, o iki rugpiūčio pabaigos į sostinę persikėlė ir valstybės įstaigos.
  šaltinis: [[A. Šapoka (red.), Lietuvos istorija (1936 m.)]]
  citata_originali: |
    ...
    duoti Lietuvai (liepos 10 d.). Tačiau paliaubų pasiūlymo So-
    ...
    mūsų žygiavimą ir sudegino Vakos tiltą. Kai liepos mėn. 15 d.
    lietuvių pulkai įžengė į Vilnių, jie čia jau rado rusus. Kadangi
    ...
    pažintą teritoriją. Tuo tarpu lenkai, prancūzų padedami, sutvar-
    ...
    liepos 27 d. nustatytos (tai antroji, arba Fošo, linija). Tą savo
    ...
    Lietuvos vyriausybė negalėjo pripažinti tos sąjungininkių
    nustatytos linijos, juo labiau kaip sienos, dėl kurios Lietuva
    net ilgai nebuvo atsiklausta. Tačiau, vengdama kraujo praliejimo,
    Lietuvos vyriausybė sutiko dalyvauti konferencijoj, kad tiesio-
    ginėmis derybomis būtų taikiai išspręsti ginčijami klausimai. Bet
    ...
    **Suvalkų derybos.** Tuo pat laiku, kai Tautų Sąjunga nu-
    ...
    peržengė tą liniją ir veržėsi į Gardino—Varėnos ruožą. Rugsėjo
    mėn. 22 d. gausingos lenkų jėgos (dvi kavalerijos brigados ir
    dvi pėstininkų divizijos) ties Gibais (Seinų srityje) pralaužė
    lietuvių frontą ir užėjo iš užpakalio. O kai, besivydami bolše-
