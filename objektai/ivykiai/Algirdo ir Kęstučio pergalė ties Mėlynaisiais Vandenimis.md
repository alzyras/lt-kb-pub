---
tipas: ivykis
pavadinimas: 'Algirdo ir Kęstučio pergalė ties Mėlynaisiais Vandenimis'
saltiniai:
...
media_all_json: |-
  []
---
# Algirdo ir Kęstučio pergalė ties Mėlynaisiais Vandenimis
...
- id: c-184624
  ...
  citata_originali: |
    ...
    valandą savo kariauną, traukė totorių drausti. Lie­
    tuviai, atėję ties Mėlynaisiais Vandenimis, pamatė
    totorius taboriuose stovinčius, kurių trys karvedžiai:
    Katlubachas, Girėjus ir Dimeiteris stipriai pasirėdę
    vedė tuojau nesuskaitomas gaujas į mūšą. Algirdas
    su Kęstučiu, tą matydamu, liepė lietuviams greitai
    rindotis, kuriuos paskui, į penkias dalis perskie-
...
- id: c-184625
  ...
  citata_originali: |
    ...
    totoriai sulenkta eila pagal savo būdą nebgalėjo be­
    kariauti, radęsi staiga nuo lietuvių apsiaustais; kai­
    pogi totoriai, išmetę savo vylyčias į tuščias vietas,
    susirėmė su lietuviais ragotinėmis ir kardomis, bet
    lig tiktai lietuviai sau kelią praskynė, tuojau eilos
    totorių suniuko; kur begalėjo tame suniukime tas
    šalin spruko; kas apsakys tą pjūvą, kokią tenai
    lietuviai vydami totorius darė; pačiais kūnais ne­
    apregimus laukus nukrėtė ir visus turtus, kas vien
    totorių taboriuose buvo, įgavo į ranką. Įgijusiu Al­
    girdas su Kęstučiu tą pergalę vėtra įsilaužė į Oča-
    kavo pilį, ant kranto Juodosios jūros esančią, ir ją
    išdrevėjo. Į antrapus Niperio upės persikėlusiu įkan­
    din vien totorius vydamu, tyruose Putivlio ir Dono
