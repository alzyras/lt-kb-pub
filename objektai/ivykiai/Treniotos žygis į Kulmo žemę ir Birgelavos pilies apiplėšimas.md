---
tipas: ivykis
pavadinimas: 'Treniotos žygis į Kulmo žemę ir Birgelavos pilies apiplėšimas (pilis)'
saltiniai:
...
media_all_json: |-
  []
---
# Treniotos žygis į Kulmo žemę ir Birgelavos pilies apiplėšimas (pilis)

## Santrauka

Dusburgietis teigia, kad apie Birgelavos pilies sugriovimą Treniota, lietuvių karaliaus sūnus436, daugelio kitų pagonių [gentibus] talkinamas, subūrė kovai iki trisdešimties tūkstančių vyrų ir, atžygiavęs prie Prūsijos žemės, padalijo juos į tris dalis437, kurių vieną nusiuntė prieš.
