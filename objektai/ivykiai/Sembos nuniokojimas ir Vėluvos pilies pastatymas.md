---
tipas: ivykis
pavadinimas: 'Sembos nuniokojimas ir Vėluvos pilies pastatymas (pilis)'
sukurta: '2026-05-30'
variantai:
  - 'Sembos nuniokojimas ir Vėluvos pilies pastatymas'
aliases:
  - 'Sembos nuniokojimas ir Vėluvos pilies pastatymas'
saltiniai:
...
tags:
  ...
  - tikėjimas
---
# Sembos nuniokojimas ir Vėluvos pilies pastatymas (pilis)

## Santrauka

Dusburgietis teigia, kad apie Sembos žemės nuniokojimą ir Vėluvos pilies pastatymą Tais pačiais metais, kai buvo pastatytas Karaliaučius, labai įtūžo kaimyninės nadruvių, skalvių ir sūduvių gentys už tai, kad sembai pasidavė tikėjimui ir broliams (jie mat būgštavo, kad dėl tos. Dusburgietis teigia, kad mat dievas palietė ir minėtojo Tirsko, pilies vado, ir kitų su juo buvusių vyrų širdis, ir jie, išsižadėję stabmeldystės, suartėjo su Kristaus tikėjimu bei broliais ir pasidarė uolūs Kristaus tikėjimo gynėjai.
...
- c-001
  ...
  pagrindžia:
    - t-001
- c-002
  santrauka: 'Dusburgietis teigia, kad mat dievas palietė ir minėtojo Tirsko, pilies vado, ir kitų su juo buvusių vyrų širdis, ir jie, išsižadėję stabmeldystės, suartėjo su Kristaus tikėjimu bei broliais ir pasidarė uolūs Kristaus tikėjimo gynėjai.'
  šaltinis: Petras Dusburgietis, Prūsijos žemės kronika (1985 m.)
  citata_originali: |
    ...
    ir atvedė prie žlugimo. Mat dievas palietė ir minėtojo Tirsko, pilies vado, ir kitų su juo
  ...
  pagrindžia:
    - t-002
- c-003
  santrauka: Sembos nuniokojimas ir Vėluvos pilies pastatymas papildomas patvirtintas šaltinio paminėjimas.
  šaltinis: Petras Dusburgietis, Prūsijos žemės kronika (1985 m.)
  citata_originali: |
    Tais pačiais metais, kai buvo pastatytas Karaliaučius, labai įtūžo kaimyninės nadruvių,
    skalvių  ir sūduvių gentys už tai, kad sembai pasidavė tikėjimui  ir broliams (jie mat
