...
- t-001
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Radvilos|Radvilos]]; mentioned_place: Rževas; mentioned_place: Starica; mentioned_place: Urdomas; mentioned_person: [[objektai/asmenys/Ivanas|Ivanas]]; mentioned_place: Pskovas; mentioned_place: Rusija; mentioned_place: Volga; llm_object: Starica; llm_object: Rževas; llm_object: Urdomas'
...
- t-002
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Rusai|Rusai]]; mentioned_person: [[objektai/asmenys/Kristupas Radvila|Kristupas Radvila]]; mentioned_person: [[objektai/asmenys/Kristupas Radvila Perkūnas|Kristupas Radvila Perkūnas]]; mentioned_place: Rusija; llm_object: [[objektai/grupes/Rusai|Rusai]]; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_place: Rževas; llm_object: Rusija'
  temporaliniai_duomenys: 'įvykio data: 1581 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
  pagrindžia:
    - c-001
...
- t-003
  ...
  susije_objektai: 'llm_object: Rževas; mentioned_group: [[objektai/grupes/Rusai|Rusai]]; mentioned_person: [[objektai/asmenys/Kristupas Radvila|Kristupas Radvila]]; mentioned_person: [[objektai/asmenys/Radvila|Radvila]]; mentioned_place: Rusija; mentioned_place: Rževas; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; llm_object: Rusija'
  pagrindžia:
    - c-001
...
- t-004
  ...
  susije_objektai: 'llm_object: Cholmas; mentioned_group: [[objektai/grupes/Radvilos|Radvilos]]; mentioned_place: Cholmas; mentioned_place: Dubnas; mentioned_group: [[objektai/grupes/Didžiojo Naugardo respublika|Didžiojo Naugardo respublika]]; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_place: Pskovas; llm_object: Dubnas'
  temporaliniai_duomenys: 'įvykio data: 1581 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
...
- t-005
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Radvilos|Radvilos]]; mentioned_place: Rževas; mentioned_place: Starica; mentioned_place: Toropecas; mentioned_place: Pskovas; mentioned_place: Rusija; mentioned_place: Urdomas; mentioned_place: Volga'
  temporaliniai_duomenys: 'įvykio data: 1581 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=27167323d186f039b2d5814b80e02fb64dd2a55d641f3985a45fba48aa1725cf; match=fallback; occurrences=0
...
- t-006
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_group: [[objektai/grupes/Radvilos|Radvilos]]; mentioned_place: Dubnas; mentioned_group: [[objektai/grupes/Didžiojo Naugardo respublika|Didžiojo Naugardo respublika]]; mentioned_place: Pskovas; llm_object: Dubnas'
  temporaliniai_duomenys: 'įvykio data: 1581 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
