---
tipas: ivykis
pavadinimas: 'Totorių invazija į Vengriją ir Lenkiją (1241 m.)'
saltiniai:
...
amziai:
  - 'XIII'
---
# Totorių invazija į Vengriją ir Lenkiją (1241 m.)

## Santrauka

Dusburgietis teigia, kad apie Vengrijos ir Lenkijos nusiaubimą Tais pačiais metais596 totoriai nuniokojo Vengriją ir Lenkiją (Ptol. Dusburgietis teigia, kad apie Vengrijos bei Lenkijos nuniokojimą ir apie Kolomano, Vengrijos karaliaus bro­ lio, ir Henriko, Vroclavo kunigaikščio, žūtį Tais pačiais metais rytų šalyse gyvenusi totorių tauta įsiveržė į Vengriją ir Lenkiją, kur mūšyje nukovė Kolomaną, Vengrijos.
...
- t-001
  ...
  susije_objektai: 'llm_object: Lenkija; llm_object: Vengrija; mentioned_place: Lenkija; mentioned_place: Vengrija; mentioned_group: [[objektai/grupes/Totoriai|Totoriai]]'
...
- t-002
  ...
  susije_objektai: 'llm_object: Vengrija; llm_object: Lenkija; mentioned_place: Lenkija; mentioned_place: Vengrija; mentioned_group: [[objektai/grupes/Totoriai|Totoriai]]; mentioned_place: Vroclavas'
  temporaliniai_duomenys: 'įvykio data: 1241 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
