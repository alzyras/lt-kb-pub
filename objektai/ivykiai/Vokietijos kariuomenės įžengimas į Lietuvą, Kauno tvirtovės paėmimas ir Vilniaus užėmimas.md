---
tipas: ivykis
pavadinimas: 'Vokietijos kariuomenės įžengimas į Lietuvą, Kauno tvirtovės paėmimas ir Vilniaus užėmimas'
saltiniai:
...
- t-001
  ...
  semantiniai_rysiai: "Vokiečiai užėmė Kaunas (0.93); Vokiečiai keliavo į Vilnius (0.84)"
  ...
  ryšio_patikimumas: "uzeme -> Kaunas: 0.93"
  ...
  ryšio_paaiskinimas: "Tekstas aiškiai sako, kad vokiečiai paėmė Kauno tvirtovę."
  pagrindžia:
    - c-23282
...
- t-002
  ...
  temporaliniai_duomenys: "įvykio data: 1915 m."
  temporalinis_paaiskinimas: "Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui."
  temporalinis_llm_pakomentavimas: "Citata palaiko tikslesnį sakinį su pavasario laiku ir tvirtovės reikšme."
  šaltinio_profilis: "žanras: istorinis_tekstas; perspektyva: kryziuociu_ordino; šališkumas: high; atribucija: required_for_interpretation; atribucijos vardas: Alfonsas Eidintas"
  ...
  ryšio_subjekto_parinkimas: "Vokiečiai: llm_allowed_candidate, group"
  ryšio_targeto_parinkimas: "Kaunas: llm_allowed_candidate, place"
  ryšio_paaiskinimas: "Claimas aiškiai nurodo vokiečių atliktą Kauno tvirtovės paėmimą."
...
- t-004
  ...
  ryšio_subjekto_parinkimas: "Vokietijos kariuomenės įžengimas į Lietuvą, Kauno tvirtovės paėmimas ir Vilniaus užėmimas: owner_note_path, event, gap=0"
  ryšio_targeto_parinkimas: "Austrija: mention_match, place, gap=14"
  ryšio_paaiskinimas: "Ryšys sukurtas taisykle \"rule_plain_mention\". Subjektas \"Vokietijos kariuomenės įžengimas į Lietuvą, Kauno tvirtovės paėmimas ir Vilniaus užėmimas\" parinktas kaip owner_note_path. Targetas \"Austrija\" parinktas kaip mention_match aplink predikatą \"mention\". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality."
  pagrindžia:
    - c-166675
