---
tipas: ivykis
pavadinimas: 'Žygimanto Kęstutaičio nužudymas per Verbų sekmadienį (1440 m.)'
saltiniai:
...
- c-001
  ...
  citata_originali: |
    ...
    beika kurį metą jautėsi lyg šaltu vandeniu perlietas; kai
    ilgainiui iš gailesčio krašto gyventojams širdyje pabudo
    neapykanta valdovui, jis pasižadėjo saugoti paslaptį ir
    talkinti sąmokslininkams. Su-
    V e rb ų
    se k m a d ie n į
    tarė nužudyti Žygimantą tą
    p a sp en d žia  p in k le s
    dieną, kurią krikščionys vadi­
    na Verbų sekmadieniu. Šven­
