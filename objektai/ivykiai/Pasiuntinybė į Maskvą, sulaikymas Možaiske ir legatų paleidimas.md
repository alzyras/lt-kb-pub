---
tipas: ivykis
pavadinimas: 'Pasiuntinybė į Maskvą, sulaikymas Možaiske ir legatų paleidimas'
saltiniai:
...
- t-002
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Valachai|Valachai]]; mentioned_place: Maskva; mentioned_place: Vilnius; mentioned_object: [[objektai/zodynas/legatai|legatai]]; mentioned_person: [[objektai/asmenys/Vasilijus|Vasilijus]]; mentioned_place: Možaiskas'
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
...
- t-003
  ...
  susije_objektai: 'llm_object: Možaiskas; mentioned_object: [[objektai/daiktai/Namas|Namas]]; mentioned_place: Možaiskas; mentioned_group: [[objektai/grupes/Valachai|Valachai]]; mentioned_person: [[objektai/asmenys/Vasilijus|Vasilijus]]'
  pagrindžia:
    - c-003
  irodymo_stiprumas: 0.00
...
- c-001
  ...
  citata_originali: |
    ...
    pasižadėjo Įeisiąs apie Kalėdas visiems belaisviams
    išvykti. Be to, sutarė teismų reikalus sutvarkyti iki
...
- c-003
  ...
  citata_originali: |
    ...
    versti keliauti pas karalių, kad jų vadovas atsisakęs
    paprašyti karalių išduoti, kaip įprasta, raštą, leidžiantį
    laisvai keliauti po jo valdas. Kai, nulydėti pas kara­
    lių, paprašė, kad jiems būtų leista grįžti pas savo val­
    dovą per karaliaus valdas, jie, nepatyrę jokių nuoskau­
    dų, bemat buvo paleisti. Štai todėl Vasilijus skubiai
    išsiuntė į Možaiską žygūną, įsakydamas tučtuojau pa­
    leisti karaliaus legatus; netrukus jie laimingai ir su­
    grįžo namo, neįžeisti tautos, kuri menkiausia proga
    be jokios gėdos galėjo pažeisti bet kurios tautos tei­
    ses.
  citata_rodoma: ''
  teiginio_tipas: saltinio_teiginys
  statusas: verified
