...
- id: c-184646
  ...
  citata_originali: |
    ...
    beįmanė tas muko šalin, bet lietuvių vyresnieji taip
    bukliai buvo savo kareivius sustatę, jog skriejan­
    čius gudus visus į verpetus Daugavos sugrūdo, kuri
    būk burgėjusi per kamšą kūnų it per purvyną (kaip
    gudas pats tų laikų rašytojas sako). Turtai ir gėry­
    bės gudų visą tą dieną teko lietuviams ir žemai­
    čiams.
    Ta pergale nekakinos dar lietuviai, nes ateinantį
    metą traukė į Baltuosius Gudus ir Juodgirėnus, ra-
    П83 dę tenai gyventojus krikščionis, daugiaus pavėdžius
    jau į gudus nekaip į lietuvius, kurie, vergaudami
    nuo 300 metų gudams, patys buvo jau išvisę į gu­
    dus, visą jų kraštą nuteriojo, priemiesčius Pleškavo
    ir Naugardo nudegino, bažnyčias nuplėšė, pilės iš­
    vertė, ir kame tiktai lietuviai ir žemaičiai ant savo
