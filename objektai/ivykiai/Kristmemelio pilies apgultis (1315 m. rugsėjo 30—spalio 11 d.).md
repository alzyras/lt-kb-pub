---
tipas: ivykis
pavadinimas: 'Kristmemelio pilies apgultis (1315 m. rugsėjo 30—spalio 11 d.)'
saltiniai:
...
amziai:
  - 'XIV'
---
# Kristmemelio pilies apgultis (1315 m. rugsėjo 30—spalio 11 d.)

## Santrauka

Dusburgietis teigia, kad rugsėjo 30—spalio 11 Tų pačių metų rugsėjo mėnesį Vytenis, lietuvių karalius, subūrė visus tinkamus karui savo karalystės vyrus ir apsupo Kristmemelio pilį, kurią 17 dienų iš visų pusių smarkiai puldinėjo su dviem apgulos mašinomis ir daugybe šaulių. Dusburgietis teigia, kad nieko šiuo būdu nepešę, galop jie 17 dieną, kai jau ketino pasitraukti, sužinoję, kad artėja magistras su didele kariuomene, priėjo pilies gynybinį griovį ir ten prinešė malkų, šieno, stagarų ir šiaudu, norėdami žūt būt pilį sudeginti.
...
- t-001
  ...
  susije_objektai: 'llm_object: Kristmemelis; mentioned_place: Kristmemelis; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_person: [[objektai/asmenys/Vytenis|Vytenis]]; mentioned_place: Semba'
...
- t-002
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_place: Kristmemelis; llm_object: Kristmemelis; mentioned_object: [[objektai/zodynas/magistras|magistras]]; mentioned_object: [[objektai/zodynas/netikėliai|netikėliai]]'
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=f1631b458761617964804fec1135ad4eacebf6b54b4147ae43e2c33053b887ac; match=fallback; occurrences=0
  sprendimo_priezastis: auto
