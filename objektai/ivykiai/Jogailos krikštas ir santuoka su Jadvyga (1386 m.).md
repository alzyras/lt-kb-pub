---
tipas: ivykis
pavadinimas: 'Jogailos krikštas ir santuoka su Jadvyga (1386 m.)'
variantai:
  - 'Jogailos krikštas ir santuoka su Jadvyga'
aliases:
  - 'Jogailos krikštas ir santuoka su Jadvyga'
saltiniai:
  - 'į Ą'
...
media_all_json: |-
  []
---
# Jogailos krikštas ir santuoka su Jadvyga (1386 m.)
...
- id: c-189412
  ...
  citata_originali: |
    Pirmąją atvykimo dieną,
    vasario 10-ąją (šv. Scholastikos), didysis kunigaikštis užsilaikė
    viename priemiesčio namelyje; ten kalbėjosi su dvasininkais,
    paskui su senatu, priėmė arkivyskupą, su visais dvariškiais, kaip
    kad sakėme, klausėsi religinių pamokymų; išsiuntė Vytautą
    pas karalienę ir iš jos gavo pasveikinimą. Pasak kitų šaltinių,
    karalienė pirmiausia iš paties Vytauto lūpų norėjo išgirsti Jo­
    gailos išteisinimą dėl Kęstučio mirties; Vytautas užtarė brolį,
    visą kaltę suversdamas Prokšai* ir grupuotei, kuriai šis žiau­
    rus žmogus priklausė. Y ra net pagrindo manyti, kad norint
    tvirčiau įtikinti karalienę, reikėjo, kad tas Kęstučio žudikas
    prisipažintų pats, ir Prokša ** buvo atvežtas į Krokuvą, gal kartu
    su Jogailos atvykimu, juk tokia sąlyga galėjo būti iš anksto iš­
    kelta3. Po to kunigaikštis per kunigaikščius - Henriką, Vytau­
    tą ir Skirgailą nusiuntė savo sužadėtinei karališkų dovanų.
