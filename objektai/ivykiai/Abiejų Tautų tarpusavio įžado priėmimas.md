---
tipas: ivykis
pavadinimas: 'Abiejų Tautų tarpusavio įžado priėmimas'
saltiniai:
...
- t-001
  ...
  ryšio_subjekto_parinkimas: "Abiejų Tautų tarpusavio įžado priėmimas: owner_note_path, event, gap=0"
  ryšio_targeto_parinkimas: "Lenkai: mention_match, group"
  ryšio_paaiskinimas: "Ryšys sukurtas taisykle \"rule_plain_mention\". Subjektas \"Abiejų Tautų tarpusavio įžado priėmimas\" parinktas kaip owner_note_path. Targetas \"Lenkai\" parinktas kaip mention_match aplink predikatą \"mention\". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, same_sentence_locality."
  šaltinio_profilis: "žanras: istorinis_tekstas; perspektyva: kryziuociu_ordino; šališkumas: high; atribucija: required_for_interpretation; atribucijos vardas: Alfonsas Eidintas"
  temporaliniai_duomenys: "įvykio data: 1791 m."
  temporalinis_paaiskinimas: "Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui."
  temporalinis_llm_pakomentavimas: "Teiginys tiksliai nusako datą, veikėją ir Abiejų Tautų tarpusavio įžado priėmimo aplinkybę."
  pagrindžia:
    - c-166602
