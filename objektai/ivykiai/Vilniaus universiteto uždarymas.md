---
tipas: ivykis
pavadinimas: "Vilniaus universiteto uždarymas"
sukurta: "2026-04-20"
variantai: []
aliases: []
saltiniai: 
...
Nurodoma, kad rusų valdžia 1832 m. uždarė Vilniaus universitetą, o po to dar kurį laiką išliko susidomėjimas Lietuvos praeitimi. (t-001)

## Laikotarpis ir datos

- laikotarpis: 1832 m. (t-001)
- datos: 1832 m. (t-001)
- amziai: XIX (t-001)
- date_start/date_end: 1832 / 1832 (t-001)
...
- c-001
  ...
  citata_originali: |
    ...
    rašo Žemaičių vyskupystės istoriją (2 t.). Iš šito periodo Lietuvos
    ...
    Kai 1832 m. rusų valdžia uždarė Vilniaus universitetą, jo sukeltas
    susidomėjimas Lietuvos praeitimi dar kurį laiką išliko. Tą darbą
    tęsė Vilniuje susibūrę uždaryto universiteto auklėtiniai ir kiti švie-
    sesni Lietuvos bajorai. Bet apie XIX a. vidurį, ypač po antrojo lenk-
    Motiejus Strikauskis.
    1548-1582 m.
    (Raižinys, pridėtas prie jo „Kronikos"
    1582 m. leidimo).
    mečio (1863 m.), kai rusų val-
    džia išdraskė visus Lietuvos
    bajorų kultūros židinius, tas
    darbas buvo apleistas. Lietuvos
    ...
    **Lenkai** ėmė rūpintis Lietu-
    ...
    Teodoras Norbutas
    (1784—1864 m.).
    menė buvusi lenkiška. Tiesa,
    lenkiškai buvo rašomi Lietuvos
    istorijos veikalai ir anksčiau,
    t.y. Vilniaus universiteto metu;
    bet tada rašė daugiausia iš Lie-
    tuvos kilę bajorai, kurie nors ir
    kalbėjo lenkiškai, tačiau labai
    mylėjo savo kraštą ir didžiavosi
    jo garsia praeitim, todėl sten-
    gėsi parodyti didingą savo kraš-
    to praeitį. O naujiesiems lenkų
    istorikams labiausiai rūpėjo iš-
    garbinti kultūrinę Lenkijos mi-
    siją, įrodyti, kad lenkai apšvie-
    tę „barbarus" pagonis lietuvius.
  citata_rodoma: ""
