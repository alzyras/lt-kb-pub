...
variantai:
  - "Tanenbergo mūšis"
  - "Mūšis tarp Tanenbergo ir Griunvaldo"
aliases:
  - "Tanenbergo mūšis"
  - "Mūšis tarp Tanenbergo ir Griunvaldo"
saltiniai:
...
- laikotarpis: 1410 m. liepos 15 d. (t-001)
- datos: 1410 m. liepos 15 d. (t-001)
- amziai: XV (t-001)
- date_start/date_end: 1410 / 1410 (t-001)

## Data ir vieta

- 1410 m. liepos 15 d. (t-001)
- Ordino žemėje, tarp [[Tanenbergas|Tanenbergo]] ir [[Griunvaldas|Griunvaldo]]. (t-001)
- Kariuomenės prieš mūšį buvo sujungtos Lenkijoje ties [[Červinskas|Červinsku]]. (t-001)

## Dalyviai ir vaidmenys

- [[Jogaila]] - laikytas visų viršininku ir davė ženklą pradėti mūšį. (t-002)
- Vytautas - rikiavo lietuvių kariuomenę ir šaltinyje vadinamas tikruoju mūšio vadu. (t-002)
- [[Zindramas iš Maškovičių]] - rikiavo lenkų kariuomenę. (t-002)
- [[Ulrichas von Jungingenas]] - ordino magistras, žuvęs mūšio vietoje. (t-003)

## Priežastys

Ši kortelė remiasi tik Šapokos pateiktu mūšio aprašymu; platesnės karo priežastys šiame įraše neplečiamos be atskiro teiginio.

## Eiga

Šaltinis aprašo, kad sąjungininkai slaptai sujungė kariuomenes, o ordinas laukė atskirų užpuolimų iš Lietuvos ir Lenkijos. Mūšyje pirmiausia smogta lietuviams; po jų pasitraukimo kovos tęsėsi prie lenkų, o vėliau Vytautas atvedė rezervus ir grįžę lietuviai užėjo kryžiuočiams iš šono. (t-001, t-002, t-003)

## Rezultatas

Šaltinis teigia, kad ordino jėgos Tanenbergo mūšyje buvo sunaikintos, ordinas nebegalėjo grobti Lietuvos žemių ir po truputį silpnėjo. (t-004)
...
- id: q-001
  ...
  patikimumo_pagrindimas: "Citata tiesiogiai nurodo mūšio datą, pasirengimą ir vietą."
  pagrindžia:
    - t-001
...
- id: q-002
  ...
  citata_originali: |
    ...
    čių, o lietuvių kariuomenę — pats Vytautas. Jogaila, specialios
    sargybos saugomas, išklausė net kelias mišias paeiliui, o Vytau-
    tas, keisdamas pavargstančius arklius, su keliais palydovais skra-
    jojo tarp kariuomenės eilių, duodamas paskutinius įsakymus.
  ...
  patikimumo_lygis: aukstas
  patikimumo_saltinis: ai
  patikimumo_pagrindimas: "Citata tiesiogiai aprašo mūšio vadovavimą ir kariuomenių rikiavimą."
  pagrindžia:
    - t-002
...
- id: q-003
  ...
  šaltinis: [[A. Šapoka (red.), Lietuvos istorija (1936 m.)]]
  citata_originali: |
    Prasidėjus mūšiui, magistras didžiausias savo rinktines jė-
    gas — sunkiai šarvuotą kavaleriją, metė prieš lietuvius. Po
    valandos karšto mūšio lietuviai pasitraukė. Liko tik eilių vidu-
    rys ir kairiajam sparne išrikiuoti lenkai. Čia dar 3 valandas ėjo
    ...
    rado ir pasitraukę dešiniojo sparno lietuviai. Greičiausiai, jie bus
    tyčia pasitraukę, norėdami nuvilioti kryžiuočius gilyn į savo ei-
    les, kad galėtų vėliau paspausti iš šono (tai buvo lietuviams ge-
    rai pažįstamas, totorių dažnai vartojamas, taktinis manevras).
    Tuo pasitraukimu nuo sąjungininkų vidurio ir kairiojo sparno
    buvo nutraukta daug priešo jėgų, kurios nespėjo laiku grįžti ir
    susitvarkyti, o grįžę lietuviai užėjo kryžiuočiams iš šono. Jiems
    
    
    paspaudus,kryžiuočių tar-
    pe kilo panika — jų eilės
    pakriko. Mūšio vietoje
    krito lietuvio ietim per-
    vertas patsai magistras
    Ulrichas von Jun-
    gingenas ir daugybė
    riterių. Dalis kariuome-
    nės dar bandė gintis, pa-
    sislėpusi už gurguolių, ta-
    čiau ir ji buvo sumušta.
    Tik maži kryžiuočių liku-
    čiai tepaspruko, o visi kiti
    žuvo kovos lauke arba
    bėgdami iš jo.
  citata_rodoma: |
    Prasidėjus mūšiui, magistras didžiausias savo rinktines jėgas — sunkiai šarvuotą kavaleriją, metė prieš lietuvius. Po valandos karšto mūšio lietuviai pasitraukė. Liko tik eilių vidurys ir kairiajam sparne išrikiuoti lenkai. Čia dar 3 valandas ėjo smarkios kovos. Kryžiuočiai buvo jau beapsupą lenkus ir būtų juos sumušę, bet tuo momentu Vytautas atvedė paskutinius savo rezervus, t. y. antrąsias kariuomenės eiles. Mūšio įkaršty atsirado ir pasitraukę dešiniojo sparno lietuviai. Greičiausiai, jie bus tyčia pasitraukę, norėdami nuvilioti kryžiuočius gilyn į savo eiles, kad galėtų vėliau paspausti iš šono. Tuo pasitraukimu nuo sąjungininkų vidurio ir kairiojo sparno buvo nutraukta daug priešo jėgų, kurios nespėjo laiku grįžti ir susitvarkyti, o grįžę lietuviai užėjo kryžiuočiams iš šono. Jiems paspaudus, kryžiuočių tarpe kilo panika — jų eilės pakriko. Mūšio vietoje krito lietuvio ietim pervertas patsai magistras Ulrichas von Jungingenas ir daugybė riterių. Dalis kariuomenės dar bandė gintis, pasislėpusi už gurguolių, tačiau ir ji buvo sumušta.
  teiginio_tipas: faktas
  patikimumo_lygis: aukstas
  patikimumo_saltinis: ai
  patikimumo_pagrindimas: "Citata tiesiogiai aprašo mūšio eigą."
  pagrindžia:
    - t-003
...
- id: q-004
  ...
  šaltinis: [[A. Šapoka (red.), Lietuvos istorija (1936 m.)]]
  citata_originali: |
    **Tanenbergo laimėjimo reikšmė.** Tanenbergo mūšyje ordino jė-
    gos buvo sunaikintos. Nors jis dar liko gana stiprus, tačiau jau ne-
    begalėjo grobti Lietuvos žemių. Pralaimėjimo garsas aplėkė visą
    pasaulį, ir visi žinojo, kad ordinas pralaimėjo mūšį ne su pagonimis,
    o su dviem valdovais krikščionim. Niekas nebeskubėjo jo gelbėti,
    kaip kad, pavyzdžiui, po katastrofiško Durbės mūšio (1260 m.); jau
    nebegalima buvo išgauti iš popiežiaus kryžiaus žygio paskelbimo.
  citata_rodoma: |
    Tanenbergo laimėjimo reikšmė. Tanenbergo mūšyje ordino jėgos buvo sunaikintos. Nors jis dar liko gana stiprus, tačiau jau nebegalėjo grobti Lietuvos žemių. Pralaimėjimo garsas aplėkė visą pasaulį, ir visi žinojo, kad ordinas pralaimėjo mūšį ne su pagonimis, o su dviem valdovais krikščionim. Niekas nebeskubėjo jo gelbėti; jau nebegalima buvo išgauti iš popiežiaus kryžiaus žygio paskelbimo.
  teiginio_tipas: faktas
  patikimumo_lygis: aukstas
  patikimumo_saltinis: ai
  patikimumo_pagrindimas: "Citata tiesiogiai aprašo mūšio reikšmę."
  pagrindžia:
    - t-004

## Ryšiai

- vietos: [[Tanenbergas]], [[Griunvaldas]], [[Červinskas]]
- susijęs daiktas: [[Du pliki kardai]]
- susiję asmenys: [[Jogaila]], Vytautas, [[Zindramas iš Maškovičių]], [[Ulrichas von Jungingenas]]
...
- Šapokos tekste vartojamas pavadinimas „Tanenbergo mūšis“; `Žalgirio mūšis` šiame šaltinio fragmente kaip forma neužfiksuota.
