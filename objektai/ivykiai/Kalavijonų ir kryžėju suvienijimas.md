---
tipas: ivykis
pavadinimas: 'Kalavijonų ir kryžėju suvienijimas'
saltiniai:
...
media_all_json: |-
  []
---
# Kalavijonų ir kryžėju suvienijimas
...
- id: c-184659
  ...
  citata_originali: |
    ...
    Zalca bruko šventam tėvui tuodu eržilu, kuriuodu
    pas suolą popiežiaus klūpančiu išrišo jis nuo visų
    nuodėmių ir išliuosavo nuo prisiegos ir įsakymų sa­
    vo zokano, drąsindamas kentėti dėl tikybos ir lai­
    mindamas juodu į kryžėjų zokaną, tuo tarpu popie­
    žiaus marčelga, nuklėstęs nuo jųdviejų kyriejus,
    karda paženklintus, apsiauste kryžėjų kyriejais, juo­
    du kryžium paženklintais.
