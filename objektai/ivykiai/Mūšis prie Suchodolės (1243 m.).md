---
tipas: ivykis
pavadinimas: 'Mūšis prie Suchodolės (1243 m.)'
variantai:
  - 'Mūšis prie Suchodolės'
aliases:
  - 'Mūšis prie Suchodolės'
saltiniai:
...
- id: c-188659
  ...
  citata_originali: |
    ...
    jotvingiai ir lietuviai. Mazovijos kunigaikštis paliko juos
    likimo valiai ir nestojo ginti nuo persekiojančių lenkų,
    mat turėjo skubėti su kariauna į Polocką, užpultą plė­
    šiančių kraštą prūsų pulkų, kurie siaubė jo sostinės
    priemiesčius ir apylinkes1 2.
  citata_rodoma: "Lemia­\nmas mūšis įvyko prie Suchodolės, kur Konrado karius iš­\ntiko nemaža nesėkmė, ypač prisikentėjo sąjungininkai — \njotvingiai ir lietuviai. Mazovijos kunigaikštis paliko juos \nlikimo valiai ir nestojo ginti nuo persekiojančių lenkų, \nmat turėjo skubėti su kariauna į Polocką, užpultą plė­\nšiančių kraštą prūsų pulkų, kurie siaubė jo sostinės \npriemiesčius ir apylinkes1 2."
  statusas: verified
