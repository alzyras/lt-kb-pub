---
tipas: ivykis
pavadinimas: 'Naugardo pasidavimas Vytautui ir duoklės nustatymas'
saltiniai:
...
Lietuvos metraštis pasakoja, kad naugardiečiai, matydami pskoviečių pasidavimą, taip pat pasižadėjo tarnauti Vytautui ir mokėti duoklę. Lietuvos metraštis pasakoja, kad Vytautas paskyrė Naugardui vietininką Simoną Alšėniškį, vadinamą Rūsčiuoju.

## Laikotarpis ir datos

- laikotarpis: po Pskovo pasidavimo
- datos:
  - po Pskovo pasidavimo
...
- t-001
  ...
  sudarymo_pagrindimas: 'Papildyta citatoje esančiu ryšiu su Vytautu ir palikta atribucija dėl šaltinio pasakojimo.'
  ...
  saltinio_vieta: hash=de2a156564ca8f4d20373682edbe6d17fe1cefcb3ef9352f911b2f2ccb539f12; match=fallback; occurrences=0
...
- t-002
  ...
  teiginio_tipas: 'saltinio_teiginys'
  sudarymo_pagrindimas: 'Motyvas apie baimę dėl žemės nuniokojimo yra interpretaciškai jautrus, todėl palikta metraščio atribucija.'
  susije_objektai: 'mentioned_group: [[objektai/grupes/Didžiojo Naugardo respublika|Didžiojo Naugardo respublika]]; mentioned_person: [[objektai/asmenys/Vytautas|Vytautas]]; mentioned_group: [[objektai/grupes/Pskoviečiai|Pskoviečiai]]; mentioned_object: [[objektai/zodynas/didysis kunigaikštis|didysis kunigaikštis]]; mentioned_object: [[objektai/zodynas/metraštis|metraštis]]; mentioned_place: Lietuva; llm_object: [[objektai/grupes/Didžiojo Naugardo respublika|Didžiojo Naugardo respublika]]'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=de2a156564ca8f4d20373682edbe6d17fe1cefcb3ef9352f911b2f2ccb539f12; match=fallback; occurrences=0
