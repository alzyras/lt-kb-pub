---
tipas: posakis
pavadinimas: 'Kraštą ugnimi ir kalaviju nusiaubę'
saltiniai:
...
tags:
  ...
  - posakis
---
# Kraštą ugnimi ir kalaviju nusiaubę

## Santrauka

- • — 126 ## Puslapis 143 Il KNYGA po įtemptos, tačiau perniek nuėjusios, pilies apsupties, kry­ žiuočiai galop atsitraukė ir, palikę Vilnių, kraštą ugnimi ir kalaviju nusiaubę, grįžo į Prūsiją ir Livoniją.

## Teiginiai

<a id="claim-t-86861"></a>
- t-001
  global_id: t-86861
  ...
  susije_objektai: 'llm_object: Livonija; llm_object: Prūsija; mentioned_object: [[objektai/daiktai/Kalavijas|Kalavijas]]; mentioned_object: [[objektai/posakiai/Ugnimi ir kalaviju|Ugnimi ir kalaviju]]; mentioned_place: Livonija; mentioned_place: Prūsija; mentioned_group: [[objektai/grupes/Kryžiuočių ordinas|Kryžiuočių ordinas]]; mentioned_person: [[objektai/asmenys/Tautvilas|Tautvilas]]; mentioned_place: Lietuva; mentioned_place: Vilnius'
  pagrindžia:
    - c-001
