...
Jadvyga savo „wiesz­ czym duchem“ (pranašingu nujautimu), kaip sako Prochaska, pranašavo ambicingam Vytautui didelių užsimojimų galą^2 ).
...
- t-001
  ...
  susije_objektai: 'mentioned_person: [[objektai/asmenys/Vytautas|Vytautas]]; mentioned_group: [[objektai/grupes/Totoriai|Totoriai]]; mentioned_person: [[objektai/asmenys/Jadvyga|Jadvyga]]; mentioned_place: Kipčakas'
  pagrindžia:
    - c-001
