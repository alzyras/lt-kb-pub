---
tipas: posakis
pavadinimas: 'krikščioniškieji plėšikautojai'
saltiniai:
...
tags:
  ...
  - posakis
---
# krikščioniškieji plėšikautojai

## Santrauka

Dusburgietis teigia, kad nemaža žinių galėjo pateikti ir „krikščioniškieji plėšikautojai“ (latrunkuliai), veikę Ordino labui.
...
- t-001
  ...
  susije_objektai: 'llm_object: [[objektai/asmenys/Pipinas|Pipinas]]; mentioned_group: [[objektai/grupes/Kryžiuočių ordinas|Kryžiuočių ordinas]]; mentioned_place: Lietuva; mentioned_place: Prūsija; mentioned_person: [[objektai/asmenys/Martynas iš Golino|Martynas iš Golino]]; mentioned_person: [[objektai/asmenys/Mata|Mata]]; mentioned_person: [[objektai/asmenys/Pipinas|Pipinas]]'
  pagrindžia:
    - c-001
...
- c-001
  santrauka: '„Krikščioniškieji plėšikautojai“, veikę Ordino labui, galėjo pateikti nemaža žinių apie Lietuvos ir Prūsijos kraštus.'
