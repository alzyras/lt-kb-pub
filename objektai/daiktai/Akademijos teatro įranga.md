...
- t-002
  ...
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Rykai|Rykai]]'
  pagrindžia:
    - c-002
...
- t-003
  ...
  sudarymo_pagrindimas: 'Pirminis teiginys yra inventoriaus fragmentas su neaiškia sintakse, todėl perrašytas į vientisą sakinį.'
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Rykai|Rykai]]'
  pagrindžia:
    - c-002
...
- c-001
  ...
  citata_originali: |
    ...
    prašmatnia optiškai apgaulia arka, piešta ant audinio.
    Avanscenų dvi, taip pat nupieštos ant audinio, šonuose -12
    paravanų su rūmų reginiais, o kiti 12 - su girios, aukštai - 4
    egzemplioriai dausų, ant audinio pieštų. Tada orkestrinė
    muzikuoti ir aikštelė rinktinei auditorijai, kur grindys - me­
    džio, kėdžių su atramomis - 4, be atramų - 4, taip pat per­
    tvara ir suolai visuomenei, prie ložės, arkadose - 4, o balko­
...
- c-002
  ...
  citata_originali: |
    ...
    nai frontone su baliustrada, į kuriuos įėjimas iš kolegijos,
    pastogėje, kur durys geležinės, su geležies vyriais, vidiniu
    prancūzišku užraktu, be rakto. Po kaire ranka irgi yra prie­
