...
## Teiginiai
- t-001
  teiginys: '1668 m. karalius grąžino karūną, kad ji būtų atiduota daugiau jėgų turinčiam naujajam karaliui.'
  pagrindžia:
    - c-001
- t-002
...
- t-011
  ...
  pagrindžia:
    - c-015
- t-012
  teiginys: 'Norėdamas « atmokėti» imp. Zigmantui už Breslavo spren­ dimą^7 , už Žemaičių priskyrimą ordinui, Vytautas buvo net priė­ męs jam husitų čekų siūlomą karaliaus karūną, ir ten buvo nu­ siuntęs keletui metų Žygimantą Kaributą.'
  pagrindžia:
    - c-016
- t-013
...
- t-019
  ...
  pagrindžia:
    - c-023
- t-020
  teiginys: 'Vytauto karūnacija Lenkijai kėlė pavojų, nes per ją Lietuva galėjo visiškai išsivaduoti iš Lenkijos.'
  pagrindžia:
    - c-024
- t-021
  teiginys: 'Čia turėjo būt išspręstas karūnacijos klausimas.'
  pagrindžia:
    - c-025
- t-022
  ...
  pagrindžia:
    - c-026
- t-023
  teiginys: 'Tačiau veltui Vytautas ir jo svečiai laukė pasiuntinių, at­ gabenančių karūnas.'
  pagrindžia:
    - c-027
- t-024
...
- c-014
  ...
  šaltinis: Zenonas Ivinskis, Lietuvos istorija iki Vytauto Didžiojo mirties (1978 m.)
  citata_originali: |
    Visu savo veikimu jis reiškėsi kaip didis kara­
...
- c-025
  ...
  citata_originali: |
    ...
    karūną. Reikėjo pagaliau suformuluoti jam galutiną atsakymą.
  citata_rodoma: ''
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
  patikimumo_saltinis: ai
...
- c-030
  ...
  citata_originali: |
    ...
    ```
    Tačiau šitą Jogailos ir Vytauto susitarimą stengėsi sukliu­
    dyt lenkų didikų delegacija.
  citata_rodoma: ''
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
  patikimumo_saltinis: ai
