...
- t-001
  ...
  sudarymo_pagrindimas: 'Teiginys tiesiogiai paremtas citata ir aiškiai apibūdina AK-47.'
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Šautuvai|Šautuvai]]; mentioned_object: [[objektai/daiktai/Statybininkų šalmai|Statybininkų šalmai]]; mentioned_place: Lietuva; mentioned_place: Vilnius'
  ...
  saltinio_vieta: hash=6705d74244c6f67afec90bb859f159a0a13a82102c3bebe12f210c8d432ddb6e; match=fallback; occurrences=0
...
- t-002
  ...
  sudarymo_pagrindimas: 'Perrašyta, kad subjektas aiškiai sutaptų su pastabos objektu.'
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Sovietų automatinis (pusiau automatinis) šautuvas SVT-40|Sovietų automatinis (pusiau automatinis) šautuvas SVT-40]]; mentioned_object: [[objektai/daiktai/Šautuvai|Šautuvai]]; mentioned_object: [[objektai/daiktai/Ginklai|Ginklai]]; mentioned_place: Vokietija'
...
- t-003
  ...
  sudarymo_pagrindimas: 'Teiginys yra aiškus, pilnas ir tiksliai perteikia citatos informaciją.'
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Sovietų automatinis (pusiau automatinis) šautuvas SVT-40|Sovietų automatinis (pusiau automatinis) šautuvas SVT-40]]; mentioned_object: [[objektai/daiktai/Ginklai|Ginklai]]'
  ...
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=494551e6bc9b08bf62780144faa3f219b46be36cfdbe4baaa47d523f575f5197; match=fallback; occurrences=0
  sprendimo_priezastis: auto
  ryšio_patikimumas: susije_su -> Sovietų automatinis (pusiau automatinis) šautuvas SVT-40: 0.85
  ryšio_patikimumo_lygis: vidutinis
  ryšio_patikimumo_priezastys: owner_before_predicate; single_candidate_target; single_candidate_actor; target_after_predicate; same_sentence_locality
