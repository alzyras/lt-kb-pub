---
tipas: daiktas
pavadinimas: 'Medžio noragai geležiniai noragai'
saltiniai:
...
tags:
  ...
  - privilegija
---
# Medžio noragai geležiniai noragai

## Santrauka

Vokiečiams užgulus jūrines jų pilis, beje: Klaipėdos, Liepojos, Lielupio ir Daugavos, kad nebgalėjo patys su svečia šalia per jūrą beprekioti, tad, nebgaudami nė nuo kur geležies žambių noragams, iš medžio juos dirbo; todėl nuo senų laikų tariama yra.
...
- t-001
  ...
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Noragai|Noragai]]; mentioned_group: [[objektai/grupes/Kalnėnai|Kalnėnai]]; mentioned_group: [[objektai/grupes/Vokiečiai|Vokiečiai]]'
  pagrindžia:
    - c-001
...
- c-001
  ...
  citata_originali: |
    Vokiečiams užgulus jūrines jų
        ...
        beprekioti, tad, nebgaudami nė nuo kur geležies žambių noragams, iš medžio juos dirbo; todėl
        nuo senų laikų tariama yra: „Lietuvis išjoja į girią raitas, o parvažiuoja važiuotas“.

    ## groups-vokieciai-006
    - status: unused
    - claim_role: supports_existing_claim
    - kategorija: grupe
    - kandidatas: Vokiečiai
    - potencialus_teiginys: Vokiečiai šiame šaltinyje nuosekliai rodomi kaip prekybą spaudžianti, pilis valdanti ir politines privilegijas gaunanti jėga.
    - public_note:
