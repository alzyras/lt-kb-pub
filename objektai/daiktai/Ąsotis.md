...
Šienapjūtėje ąsočiai vartojami maistui ir gėrimui vežti į pievas. Vestuvių pasakojime ąsotis naudojamas alui nešti ir statyti ant stalo.
...
- id: c-177680
  ...
  citata_originali: |
    Viena
    mergaitė tvarko arklį, kita rūpina indus.
...
- id: c-177683
  ...
  citata_originali: |
    Išleisdama
    valgymus į pievas, šeimininkė pati sukrauna į ratus, rūpindamasi, kad
    puodai nesudužtų, kad viralas nesiteleškuotų, kad neišsilaistytų. Viena
    mergaitė tvarko arklį, kita rūpina indus.
    Kamščiai ąsočiams padaryti
    iš suraitytų karnų, apvyniotų skarmaliukais ir ant viršaus kopūstla­
    piais.
