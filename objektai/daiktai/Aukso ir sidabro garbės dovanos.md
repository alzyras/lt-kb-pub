---
tipas: daiktas
pavadinimas: 'Aukso ir sidabro garbės dovanos'
saltiniai:
  - 'į Ą'
sukurta: ''
atnaujinta: ''
...
media_all_json: |-
  []
---
# Aukso ir sidabro garbės dovanos
...
- id: c-189534
  ...
  puslapiai: "PDF 223"
  indeksas: "Lietuvių tautos istorija, t. 5, PDF 223."
  citata_originali: |
    Kai puota ėjo į pabaigą, ku­
    nigaikščiui pamojus, buvo atnešta daugybė sidabro ir aukso
    daiktų, skirtų dovanoti pagarbos ženklam Du riteriai: H enri­
    kas Pruchdorfas iš Holšteino ir Bertoldas Puchenau iš Hese-
    no, taip pat ginklanešys Zigfridas Forsteris buvo pripažinti
    aukščiausių garbės dovanų verti.
  statusas: verified
  atnaujinta: "2026-08-16 22:50"
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
