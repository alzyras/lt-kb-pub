...
- c-004
  šaltinis: A. Šapoka (red.), Lietuvos istorija (1936 m.)
  citata_originali: |
    Lenkijos dabar po gabalą teko visoms
    trims valstybėms, o Lietuva beveik visa atiteko vienai Rusijai;
    tik visas kairysis Nemuno krantas (Užnemunė) atiteko Prūsijai
    ir išbuvo jos valdžioje iki Napoleono laikų (žiūr. žemėlapy).
...
- c-007
  ...
  citata_originali: |
    **Reformų sąjūdis.** Stanislovo Augusto laikais valstybės gy-
    ...
    reformų. Tiesa, pirmosios Čartoriskių reformos buvo tuojau
    apgriautos.
  citata_rodoma: ''
  teiginio_tipas: faktas
  statusas: verified
