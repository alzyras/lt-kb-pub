...
- id: c-169522
  ...
  citata_originali: |
    Neturint rūmuose bendrininkų, vargu
    ar galima buvo tikėtis sėkmės, tačiau kreiptis į juos
    neleido baimė, kad sumanymas per anksti neiškiltų aikš­
    tėn, ypač dėl to, kad visi žinojo, kokia trapi rūmininkų
    ištikimybė. Kaip žinoma, drąsūs siekimai reikalauja ne­
    paisyti pavojaus. Jonas bei kiti sąmokslininkai kreipėsi
    į žirgininką Skabeiką, kilusį iš Kijevo, visa ko jam ža­
    dėdami: tegu, girdi, nebijąs paremti jų sumanymo, ku­
    ris, palyginus su tuo, ką ketina daryti Žygimantas, nie­
