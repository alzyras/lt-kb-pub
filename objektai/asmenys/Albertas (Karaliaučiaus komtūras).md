---
tipas: asmuo
pavadinimas: 'Albertas (Karaliaučiaus komtūras)'
saltiniai:
...
- t-001
  ...
  sudarymo_pagrindimas: 'Mirakulinis pasakojimas reikalauja atribucijos, o pradinė formuluotė per ilga.'
  susije_objektai: 'mentioned_object: [[objektai/daiktai/Paplotėlis|Paplotėlis]]; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_object: [[objektai/daiktai/Kryžius|Kryžius]]; mentioned_person: [[objektai/asmenys/Kūnas|Kūnas]]; mentioned_person: [[objektai/asmenys/Mergelė Marija|Mergelė Marija]]; mentioned_place: Lietuva; llm_object: Lietuva'
  semantiniai_rysiai: '[[objektai/asmenys/Albertas (Karaliaučiaus komtūras)|Albertas (Karaliaučiaus komtūras)]] surengė žygį į Lietuva'
  pagrindžia:
    - c-001
  ...
  ryšio_subjekto_parinkimas: Albertas (Karaliaučiaus komtūras): llm_allowed_candidate, person
  ryšio_targeto_parinkimas: Lietuva: llm_allowed_candidate, place
  ryšio_paaiskinimas: Citata tiesiogiai sieja Albertą su žygiu prieš Lietuvą, nors jis aprašomas kaip žygio dalyvis, ne vienintelis organizatorius.
