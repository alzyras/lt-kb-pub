...
- id: c-169474
  ...
  citata_originali: |
    Tokį
    J o g a ila p e rd u o d a šį
    pat atsakymą išgirdo ir Vy-
    siū ly m ą se n a tu i
    tautas, kai, susitaręs su impe­
    ratoriumi dėl savo pakėlimo į
    karalius laiko, šio akivaizdoje mėgino išgauti iš kara­
    liaus pritarimą. Sukvietus senatą, Vytautas ilgoje kal­
    boje iškėlė savo nuopelnus valstybei, papasakojo, ko
    trokšta valdiniai, ką mano šiuo klausimu svetimšaliai
    ir apie visa kita, kas, jo gal-
    V y ta u ta s se n a te gin a
    va, galėjo būti naudinga, o
    sa v o re ik a lą
    galop paprašė, kad jam būtų
    leista dalyvauti senato posė­
    dyje, kai bus svarstomas šis reikalas. Mat žinojo, kad
