...
- c-001
  ...
  pagrindžia:
    - t-186193
- c-002
  santrauka: 'Narbutas Danutę mini kaip Kęstučio ir jo žmonos dukterį, gimusią kartu su sūnumis Patriku, Vytautu, Tautvilu ir Sigailu, arba Žygimantu.'
...
- id: c-169554
  ...
  citata_originali: |
    ...
    ir
    parūpino jam
    įrankių kalėjimo sienai prasikalti, drabužių, pasiūtų
    taip, kaip siūdinasi kryžiuočiai, kad niekas nesupras­
    tų, kas joja, be to, žirgą ir kitokių bėgliui reikalingų
    daiktų; vidudienį Kęstutis ir pabėgo iš kalėjimo bei
    pilies. Pasakojama, kad viskas buvę taip sumaniai pa­
    rengta, jog raitelį, jojantį iš pilies per miestą, patys
    kryžiuočiai laikė kryžiuočiu ir jį sveikino. Vakarop
    pasiekęs miškus, jis paleido žirgą, norėdamas suklai­
    dinti persekiotojus, ir pasislėpė pelkėtoje vietoje; ten
