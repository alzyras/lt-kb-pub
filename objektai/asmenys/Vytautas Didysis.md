...
## Teiginiai
- t-001
  teiginys: '— 2 — Vytautas, apie kurį mes čia kalbėsime, buvo žymiausias šios dinastijos atstovas, kaip galingas ir labai didelis ąžuolas, išaugęs kitų miško medžių tarpe.'
  pagrindžia:
    - c-001
- t-002
...
- t-007
  ...
  pagrindžia:
    - c-007
- t-008
  teiginys: 'Jo krikštatėviu buvo Ragainės komtūras Vy­ gandas von Baldersheimas, dėl to ir Vytautas apsikrikštijo Vy­ gando vardu^1 ).'
  pagrindžia:
    - c-008
- t-009
...
- t-013
  ...
  pagrindžia:
    - c-013
- t-014
  teiginys: '153 sustiprėjusi Vytauto padėtis.'
  pagrindžia:
    - c-014
- t-015
...
- t-022
  ...
  pagrindžia:
    - c-022
- t-023
  teiginys: 'Ištikimybės prie­ saikos aktuose dėl Lenkijos įpėdinių lenkai prisiekė, kad, mirus Jogailai, jo vaikų globėjas bus Vytautas.'
  pagrindžia:
    - c-023
- t-024
  teiginys: 'Vytauto karūnacijos klausimas, iškeltas 1429 m. Lucko su­ važiavime, buvo nebe naujas.'
  pagrindžia:
    - c-024
- t-025
...
- t-027
  ...
  pagrindžia:
    - c-027
- t-028
  teiginys: 'Nežiūrint visų nesusipratimų su lenkais, Vytautas ir dabar atvykusiems pasiuntiniams buvo malonus ir vaišingas: nesigai­ lėjo jiems visokių dovanų, o išvykstant, pats palydėjo iki Vol­ kovisko.'
  pagrindžia:
    - c-028
- t-029
...
- t-032
  ...
  pagrindžia:
    - c-032
- t-033
  teiginys: 'Visi šių kunigaikščių, daugiausia jau minėtų tėvynainių, dvarai su visa dirbama ir nedirbama žeme, žmonė­ mis, gyvuliais ir padargais pateko į tiesioginę Vytauto valdžią.'
  pagrindžia:
    - c-033
- t-034
  ...
  pagrindžia:
    - c-034
- t-036
  teiginys: 'Kaip vertino Vytautas karines pareigas už žemę, rodo ir tai, kad gausiai dalino žemių visai ne bajorų kilmės žmonėms, kurie už tai turėjo raiti tarnauti kariuomenėje.'
  pagrindžia:
    - c-036
- t-037
...
- c-005
  ...
  citata_originali: |
    ...
    žmonių karo tarybą, kuriai pirmininkas buvo Vytautas. Bet
    tarybos reikšmė buvo menka, nes čia viską tvarkė pats Vy­
    tautas. Toji pati taryba turėjo išspręsti ir tolimesnį kariuome­
    ...
    jau surasti vadovai ir nustatytas kelias. „Tokiu būdu veiklusis
    Vytautas, apsuptas septynių tarybos, išklausinėjęs vadovus,
    davė parėdymus, kur eiti, kur sustoti, — žodžiu, pildydamas
    vyriausio vado pareigas, tvarkė visą kariuomenės judėjimą ir
    veikimą“ (Dlugošas).
  citata_rodoma: ''
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
...
- c-007
  ...
  citata_originali: |
    ...
    nebūtų stojęs skersai kelio Vytautas, kuris visai netikėtai, pa­
    bėgęs iš Krėvės kalėjimo, atsidūrė pas Vokiečių Ordiną. Čia
    jis ne tiktai Vok. Ordiną palenkė į savo pusę ir pradėjo su Jo­
    gaila karą, bet ir pirmiau už jį pasiskubino priimti katalikų ti­
    kėjimą. Tai įvyko 1383 m. spalių mėn. 21 d. Tapiau mieste­
...
- c-017
  ...
  citata_originali: |
    ```
    Vytautas, naujais pasižadėjimais nuraminęs lenką galvas
    ir susiderinęs su Ordinu, pasuko į rytus sutvarkyt Smolensko
    reikalą. Čia jam ir sekėsi: atsiėmė Smolenską, o su D. Naugar­
    du sureguliavo santykius. Tuo metu pagerėjo reikalai ir su
...
- c-021
  ...
  šaltinis: Vytautas Didysis 1350-1430 (1930 m.)
  citata_originali: |
    Todėl nenuostabu, kad tas nesuta­
    rimas pasireiškė ir 1414 m. kare. Karas buvo paskelbtas Vy­
    ...
    kariuomenės dalims. Bet Vytautas ir dabar, kaip ir 1410 m.,
    ėmė greit rodyti norą grįžti į Lietuvą, visiškai neatsižvelgdamas
    nei į lenkų bajorų, ypač didžlenkių, pasipriešinimą, kurie ypa­
    tingai buvo žygio pasisekimu suinteresuoti. Vytautas skubiai
    įvykdė savo pasiryžimą. Pametė Jogailą ir lenkų būrius prie
    Brodnicos mūrų, o pats paskubom sugrįžo į Lietuvą^1 ).
  citata_rodoma: ''
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
  patikimumo_saltinis: ai
...
- c-023
  ...
  citata_originali: |
    Ištikimybės prie­
    saikos aktuose dėl Lenkijos įpėdinių lenkai prisiekė, kad, mirus
    Jogailai, jo vaikų globėjas bus Vytautas. Bet lenkai, atsidūrę į
    keblią padėtį — Vytautui ir Lietuvai daug daugiau žadėjo: buvo
    ...
    194
    ```
    suteiktas patariamasis balsas Lenkijos karaliaus rinkimuose,
    kas sutiko ir su unijos aktais^1 ). Šis vaidmuo Lietuvai pagal uni­
    jos aktus, turėjo atitekti tuo atveju, jei pasibaigtų Jogailos pa­
    likuonys, ko Vytautas, aišku, nesitikėjo susilaukti. Kadangi vie­
...
- c-028
  ...
  šaltinis: Vytautas Didysis 1350-1430 (1930 m.)
  citata_originali: |
    (^3) ) „Odbierać zaś koronę królestwa Polskiego bratu, byłoby z jego
    — 218 —
    ...
    219
    ```
    čius lenkus Jis atsisakė nuo Lenkijos karūnos, bet neatsisakė
    nuo savo pasiryžimo — apsikarūnuot.
...
- c-036
  ...
  citata_originali: |
    ...
    239
    ```
    šlėkta, kurios pavyzdžiu buvo sekama duodant privilegijas, tu­
    rėjo ir šiose pareigose daugiau laisvės.
    Kaip vertino Vytautas karines pareigas už žemę, rodo ir
    tai, kad gausiai dalino žemių visai ne bajorų kilmės žmonėms,
    kurie už tai turėjo raiti tarnauti kariuomenėje. Jiems suteikda­
    vo Vytautas bajorų titulus ir teises, neatsižiūrėdamas į Horod­
    lės unijos nuostatus, kurie turėjo bajorus išskirti iš kitų luomų^1 ).
  citata_rodoma: ''
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
  patikimumo_saltinis: ai
