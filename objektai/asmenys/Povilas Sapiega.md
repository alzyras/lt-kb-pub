...
- t-001
  ...
  susije_objektai: 'llm_object: [[objektai/grupes/Švedai|Švedai]]; mentioned_group: [[objektai/grupes/Bajorai|Bajorai]]; mentioned_group: [[objektai/grupes/Bajorų konfederacija|Bajorų konfederacija]]; mentioned_group: [[objektai/grupes/Švedai|Švedai]]; mentioned_object: [[objektai/zodynas/konfederacija|konfederacija]]; mentioned_place: Lenkija; mentioned_place: Lietuva; mentioned_place: Rusija; mentioned_place: Švedija'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
  saltinio_vieta: 519834-520238; hash=9b485bb73858604be4394063cd6ee57a9bb54f49faf4bb7b214333688f068309; match=exact
...
- t-002
  ...
  sudarymo_pagrindimas: 'Pradinis teiginys buvo per ilgas ir nutrūko ties neišvardytu asmeniu.'
  ...
  temporalinis_llm_pakomentavimas: 'Pradinis teiginys buvo per ilgas ir nutrūko ties neišvardytu asmeniu.'
  pagrindžia:
    - c-003
  irodymo_stiprumas: 0.00
  ...
  ryšio_subjekto_parinkimas: Povilas Sapiega: owner_note_path, person, gap=0
  ryšio_targeto_parinkimas: Gardinas: mention_match, place, gap=109
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Povilas Sapiega" parinktas kaip owner_note_path. Targetas "Gardinas" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
...
- t-003
  ...
  sudarymo_pagrindimas: 'Teiginys aiškiai sieja Povilo Sapiegos vadovavimą su 1661 m. išvadavimais.'
  susije_objektai: 'mentioned_group: [[objektai/grupes/Lietuvos kariuomenė|Lietuvos kariuomenė]]; mentioned_group: [[objektai/grupes/Rusijos kariuomenė|Rusijos kariuomenė]]; mentioned_group: [[objektai/grupes/Sapiegos|Sapiegos]]; mentioned_place: Gardinas; mentioned_place: Kaunas; mentioned_place: Lenkija; mentioned_place: Lietuva; mentioned_group: [[objektai/grupes/Rusai|Rusai]]; mentioned_place: Kijevas; mentioned_place: Rusija; mentioned_place: Smolenskas'
...
- c-002
  ...
  pagrindžia:
    - t-003
- c-003
  santrauka: 'Povilas Sapiega buvo vienas bajorų konfederacijos vadovų, kovojusių prieš švedus ir jų sąjungininkus.'
  šaltinis: Karolis Zikaras (sud.), Žymiausi Lietuvos mūšiai ir karinės operacijos (2013 m.)
  citata_originali: |
