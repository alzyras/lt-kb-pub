...
Oršoje (karaliaus Zigmanto fundacija), Smolenske (klebono Lempickio ir kt.

## Teiginiai
- t-001
  teiginys: 'Oršoje (karaliaus Zigmanto fundacija), Smolenske (klebono Lempickio ir kt.'
  pagrindžia:
    - c-001

## Reikšmingi paminėjimai
- c-001
  santrauka: 'Oršoje (karaliaus Zigmanto fundacija), Smolenske (klebono Lempickio ir kt.'
