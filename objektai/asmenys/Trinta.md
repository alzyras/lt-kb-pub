...
- t-001
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Notangai|Notangai]]; mentioned_person: [[objektai/asmenys/Misinas|Misinas]]; mentioned_place: Bartenšteinas; mentioned_object: [[objektai/zodynas/magistras|magistras]]'
  pagrindžia:
    - c-001
  ...
  ryšio_subjekto_parinkimas: Trinta: owner_note_path, person, gap=0
  ryšio_targeto_parinkimas: Bartenšteinas: mention_match, place, gap=88
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Trinta" parinktas kaip owner_note_path. Targetas "Bartenšteinas" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
- susijęs iš Rumšiškės: Atšilimo laikotarpiu Rumšiškėse netoli Kauno buvo įsteigtas Liaudies buities muziejus.
## Reikšmingi paminėjimai

- c-001
  santrauka: 'Trinta kartu su Govina, Stanta ir Misinu rengė notangų žygį, per kurį Stanta įsibrovė į Bartenšteino pilį.'
