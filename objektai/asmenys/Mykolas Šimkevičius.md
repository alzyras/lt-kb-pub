---
tipas: asmuo
pavadinimas: 'Mykolas Šimkevičius'
saltiniai:
...
media_all_json: |-
  []
entity_id: "ent-84a35e50199f53e1b1430a8b"
canonical_name: "Mykolas Šimkevičius"
entity_roles: ["person"]
entity_view_role: "person"
entity_aliases: ["Mykolas Šimkevičius"]
sameAs: []
...
Patikrinti pareiškimo į Fredą kartu su ūkvedžiu išvyko metinis (valdantysis) burmistras Mykolas Šimkevičius, tarėjas Povilas Bivilis ir bendruomenės prisiekusieji.
...
- id: c-185461
  ...
  citata_originali: |
    ...
    vyko metinis (valdantysis) burmistras Mykolas Šimkevičius, tarėjas Povilas Bivilis
    ir bendruomenės prisiekusieji. Jie nustatė, kad kai kurie miestiečiai iškirto miesto
    girios plotus, pavertė juos ariamąja žeme, iš miesto pievų prišienavo po keliasdešimt
    vežimų šieno.
  statusas: verified
