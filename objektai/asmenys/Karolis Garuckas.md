...
- t-001
  ...
  sudarymo_pagrindimas: 'Perrašyta tiksliau, įvardijant grupę ir išlaikant citatos faktus.'
  susije_objektai: 'mentioned_place: SSRS; mentioned_group: [[objektai/grupes/Maskvos Helsinkio grupė|Maskvos Helsinkio grupė]]; mentioned_object: [[objektai/zodynas/kunigas|kunigas]]; mentioned_person: [[objektai/asmenys/Tomas Venclova|Tomas Venclova]]; mentioned_place: Maskva; mentioned_place: Vilnius'
  ...
  ryšio_subjekto_parinkimas: Karolis Garuckas (kunigas): owner_note_path, person, gap=0
  ryšio_targeto_parinkimas: SSRS: mention_match, place, gap=35
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Karolis Garuckas (kunigas)" parinktas kaip owner_note_path. Targetas "SSRS" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
