---
tipas: asmuo
pavadinimas: 'Eimaras iš Cezarėjos'
saltiniai:
...
- t-001
  ...
  sudarymo_pagrindimas: 'Reikia aiškiau įvardyti Eimaro veiksmą, o ne vien jo paminėjimą sąraše.'
  ...
  ryšio_subjekto_parinkimas: Eimaras iš Cezarėjos: owner_note_path, person, gap=0
  ryšio_targeto_parinkimas: Albertas: mention_match, person
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Eimaras iš Cezarėjos" parinktas kaip owner_note_path. Targetas "Albertas" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, same_sentence_locality.
