...
- t-001
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Baltai|Baltai]]; mentioned_object: [[objektai/daiktai/Žirgai|Žirgai]]; mentioned_group: [[objektai/grupes/Rytas|Rytas]]; mentioned_object: [[objektai/zodynas/fogtas|fogtas]]; mentioned_place: Semba; mentioned_place: Viena; llm_object: Semba'
  semantiniai_rysiai: '[[objektai/asmenys/Dargis|Dargis]] gyveno Semba'
  pagrindžia:
    - c-001
...
- c-001
  santrauka: 'Dargis buvo Žiokos valsčiuje gyvenęs prūsas, nepakentęs baltų žirgų ir po Ditricho bandymų atsisakęs prietaro.'
