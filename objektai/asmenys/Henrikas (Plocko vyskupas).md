---
tipas: asmuo
pavadinimas: 'Henrikas (Plocko vyskupas)'
saltiniai:
...
- id: c-169403
  ...
  citata_originali: |
    Dabar, kai šis rūpestis nukrito
    nuo galvos, karalius galėjo
    1392 m e ta i
    ramia širdimi galvoti ir apie
    Vytauto grąžinimą į valdžią,
    tikėdamasis, kad nesunku būsią su juo suartėti. Kadan­
    gi Vytautas, trokšdamas suartėti, ryžtingai visokiais bū­
    dais veržėsi į sostą, su pagrindu galima buvo manyti,
    kad jis, suteikus jam tvirtesnę nei anksčiau viltį gauti
    valdžią, pereisiąs į karaliaus pusę. Todėl ir buvo nutar­
