---
tipas: asmuo
pavadinimas: 'Andrius (Vilniaus vyskupas)'
saltiniai:
...
Vilniaus vyskupas Andrius buvo kilęs iš Vilniaus ir garsėjo šventųjų mokslų pažinimu bei proto aštrumu.
...
- t-001
  ...
  susije_objektai: 'llm_object: Vilnius; mentioned_person: [[objektai/asmenys/Vaitiekus Taboras|Vaitiekus Taboras]]; mentioned_place: Vilnius'
  semantiniai_rysiai: '[[objektai/asmenys/Andrius (Vilniaus vyskupas)|Andrius (Vilniaus vyskupas)]] gimė Vilnius'
  pagrindžia:
    - c-001
...
- c-001
  santrauka: 'Vilniaus vyskupas Andrius buvo kilęs iš Vilniaus ir garsėjo šventųjų mokslų pažinimu bei proto aštrumu.'
