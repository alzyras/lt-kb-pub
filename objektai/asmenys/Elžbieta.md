...
- t-001
  ...
  saltinio_vieta: hash=7e5bb4e144e79e765a72c1f815632265148c896ada8c99f448ebb9fbe0590a4f; match=fallback; occurrences=0
...
- t-002
  ...
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=9bd83b08d66508c14783dfa79238adc506ae0192af8d9f7305bd4beba598e2f2; match=fallback; occurrences=0
  sprendimo_priezastis: auto
...
- t-003
  ...
  sprendimo_priezastis: auto
  ryšio_patikimumas: keliavo_i -> Vilnius: 0.99
  ryšio_patikimumo_lygis: aukstas
  ryšio_patikimumo_priezastys: owner_before_predicate; single_candidate_target; single_candidate_actor; target_after_predicate; same_sentence_locality
  ryšio_sprendimo_taisykle: rule_travel_local_target
  ryšio_subjekto_parinkimas: Elžbieta: owner_note_path, person, gap=53
  ryšio_targeto_parinkimas: Vilnius: nearest_after_predicate, place, gap=9
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_travel_local_target". Subjektas "Elžbieta" parinktas kaip owner_note_path. Targetas "Vilnius" parinktas kaip nearest_after_predicate aplink predikatą "keliavo". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.

<a id="claim-t-82294"></a>
- t-004
  global_id: t-82294
  teiginys: 'Elžbieta buvo Vengrijos karalienė ir Jadvygos motina.'
  susije_objektai: 'mentioned_group: [[objektai/grupes/Vengrai|Vengrai]]; mentioned_place: Vengrija; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_group: [[objektai/grupes/Pranciškonų ordinas|Pranciškonų ordinas]]; mentioned_person: [[objektai/asmenys/Algirdas|Algirdas]]; mentioned_place: Lietuva; mentioned_place: Vilnius'
  temporaliniai_duomenys: 'įvykio data: 1377 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
  pagrindžia:
    - c-008
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=5974f723f323ed16615880df7ad418e147b69500b077ba79c30864c624f55215; match=fallback; occurrences=0
  sprendimo_priezastis: auto
...
- t-005
  ...
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=9393eaacc3ddab8bea287236aadfd34c57eb076231c22e15beb83dd2a6162abb; match=fallback; occurrences=0
  sprendimo_priezastis: auto
...
- t-007
  ...
  pagrindžia:
    - c-006
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=982f023aa6f58c3e33548449cd81108d83d44263e19e91837fc48d870939c4de; match=fallback; occurrences=0
  sprendimo_priezastis: auto
...
- t-008
  ...
  susije_objektai: 'mentioned_place: Perudža; mentioned_person: [[objektai/asmenys/Grigalius IX|Grigalius IX]]'
  ...
  pagrindžia:
    - c-004
  irodymo_stiprumas: 0.00
  saltinio_vieta: hash=b3b867c92fe15aeab3e0b3d32c963e678ea6b8f556489600aa77483184a6a60b; match=fallback; occurrences=0
  sprendimo_priezastis: auto
...
- t-009
  ...
  ryšio_patikimumo_priezastys: owner_before_predicate; single_candidate_target; single_candidate_actor; target_after_predicate; same_sentence_locality
  ryšio_sprendimo_taisykle: rule_travel_local_target
  ryšio_subjekto_parinkimas: Elžbieta: owner_note_path, person, gap=63
  ryšio_targeto_parinkimas: Vilnius: nearest_after_predicate, place, gap=9
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_travel_local_target". Subjektas "Elžbieta" parinktas kaip owner_note_path. Targetas "Vilnius" parinktas kaip nearest_after_predicate aplink predikatą "keliavo". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
...
- t-010
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Lenkai|Lenkai]]; mentioned_place: Vengrija; mentioned_person: [[objektai/asmenys/Marija|Marija]]'
  ...
  pagrindžia:
    - c-009
  irodymo_stiprumas: 0.00
  saltinio_vieta: 367202-367595; hash=78bff9108da098775392b65cac4e83f78d00f3d6961ae084b373a700d14d587f; match=ocr_normalized
  sprendimo_priezastis: auto
...
- t-011
  ...
  pagrindžia:
    - c-010
  irodymo_stiprumas: 0.00
  saltinio_vieta: 1195167-1195690; hash=5cea5c5e076f4d6854f8302bba3e1acbdebf776c8b017913da302bc8fc64463d; match=exact
  sprendimo_priezastis: auto
