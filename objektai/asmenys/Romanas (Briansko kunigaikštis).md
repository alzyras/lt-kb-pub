...
- id: c-176125
  ...
  citata_originali: |
    ...
    stabdė naktis. Naktį pasilsėję, o kitą dieną iš pat ryto
    kaip reikiant atsigavę po neseniai patirtos nelaimės,
    tačiau be didelių įstangų atrėmė pirmuosius lietuvių
    antpuolius, mat tirštai gyvenamame mieste nestigo vy­
...
- id: c-178781
  ...
  citata_originali: |
    ...
    bio jų krašte prisiplėšti, o savo valdžią jiems primes­
    ti: jie pamatė, kad priešas trokšta užimti pačią tautos
    bei valstybės sostinę Kijevą. Iškilęs pavojus paskatino
