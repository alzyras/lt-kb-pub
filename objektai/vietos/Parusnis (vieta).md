...
- id: c-184472
  ...
  citata_originali: |
    ...
    vus atlyžinę, vienok tarnus švento Vaitiekaus mū-
    čelnyko paleidę sveikus, kurie pargrįžę namon Bo­
    leslovui karaliui nelaimą Vaitiekaus apipasakojo.
...
- id: c-184473
  ...
  citata_originali: |
    ...
    džionų, sukeltos popiežiaus balsu iš Teutonijos ir
    Čekų kariauti netikėlių lietuvių. Atvedė tas gau­
    jas į Parusnį karvedžiai Zinenbergas ir Ekerbergas
    su daugybe diduomenės, su kuriais mistras kryžėjų
    susinėręs gulė visuotinai į Lietuvą. Nes atsitiko tą
    žiemą taip baisūs speigai, jog ne vien vaisių me­
    džiai, bet pačios girios vietomis pavasarį nebišspro-
    go, pati jūra Žemaičių per 15 mylių užšalo nuo pa­
    šalio taip, jog iš Danijos į Liubeką galėjo pėsčia
    jūra ateiti; gyvoliai meldžionų ir patys, nepratę į
    taip baisius speigus, mažne visi išstipo nieko gero
    nenuveikę jau Parusny, jau Lietuvoj.
  statusas: verified
  atnaujinta: "2026-07-16 14:31"
  teiginio_tipas: faktas
  patikimumo_lygis: vidutinis
...
- id: c-184474
  ...
  citata_originali: |
    ...
    jant, nuo antpuolių netikėlių gynioti.
    Rudenop atėjo nauja talka meldžionų į Parusnį,
    kurią atvedė viešpats Essų Otas. Marčelga kryžė­
    jų, sukėlęs visą savo kariauną, susinėrė vėl su mi­
    na votais meldžionimis ir traukė Veliuonon; žemai­
    čiai norėjo jiems kelią užstoti, ištiko į mūšą, bet
    apsiskardžiusios šalys atsitraukė be didžio nuokry-
    čio.
  statusas: verified
  atnaujinta: "2026-07-16 14:31"
  teiginio_tipas: faktas
