...
- t-002
  teiginys: '— 99 — (1393) Dievo Apveizdos bažnyčias, o kiek vėliau pastatė ir šiose vietose bažnyčias: Švenčionyse, Perlojoje, Trakuose, Gardine, Breste ir kt.'
  pagrindžia:
    - c-002
- t-003
...
- c-001
  ...
  pagrindžia:
    - t-001
- c-002
  santrauka: '— 99 — (1393) Dievo Apveizdos bažnyčias, o kiek vėliau pastatė ir šiose vietose bažnyčias: Švenčionyse, Perlojoje, Trakuose, Gardine, Breste ir kt.'
  šaltinis: Vytautas Didysis 1350-1430 (1930 m.)
  citata_originali: |
    Tuojau jis pastatė Vilniuje Šv. Onos^3 ), Dauguose

    (^1) ) Kurcz., 105 p.
    (^2) ) Kurcz., 22 p.
    (^3) ) Nereikia jos maišyti su dabartine Vilniaus šv. Onos bažnyčia. Vy­
    tauto statytosios dabar jau nėra.


    ```
    — 99 —
    ```
    (1393) Dievo Apveizdos bažnyčias, o kiek vėliau pastatė ir šiose
    vietose bažnyčias: Švenčionyse, Perlojoje, Trakuose, Gardine,
    Breste ir kt.
  citata_rodoma: ''
  teiginio_tipas: faktas
