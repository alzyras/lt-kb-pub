...
## Santrauka
Šaltinyje vieta „Mozūrai“ siejama su šiuo kontekstu: Minimi kaip Konrado valdoma sritis ir kaip Kulmo žemės savininkai. (t-001)

## Pavadinimai šaltiniuose
- Pagrindinė forma: Mozūrai
- Šaltinyje fiksuotos formos: Mozūrams; Mozūrų

## Laikotarpis ir datos
- Šaltinio citatose aiškus laikotarpis ar data nenustatyti.

## Kas tai
- tipas: kraštas / kunigaikštystė
...
- id: q-001
  ...
  citata_originali: |
    ...
    mės pakraštėj.
  citata_rodoma: |
    Tada Mozūrų kunigaikštis Konradas, kuriam ypatingai rūpėjo pakrikštyti prūsus, vyskupą Kristijoną įkurdino Kulmo (priklausiusio Mozūrams) žemės pakraštėj.
