...
- c-001
  ...
  citata_originali: |
    ...
    tokį argumentą, beveik įrodymą: sudegė mediniai namai, išsi­
    dėstę iš visi į trijų pilies pusių, vėjas visa jėga ugnį pūtė taip, jog
    anapus Lydos pilies, už kūdros, per keletą sieksnių sudegė visi
    klojimai, bet pušys išliko*.
