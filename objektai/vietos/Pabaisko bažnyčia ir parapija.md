---
tipas: vieta
pavadinimas: 'Pabaisko bažnyčia ir parapija'
saltiniai:
...
- c-001
  santrauka: 'Pagal fundaciją nustatytose ribose karčemos turėjo priklausyti Pabaisko bažnyčiai.'
  ...
  citata_originali: |
    ...
    tyti midų, alų, degtinę ir įvairiausių rūšių gėrimus. Jeigu
    kas išdrįstų tai pažeisti ar veikti jėga prieš smuklininką ar jo
    šeimynykščius, toksai turės sumokėti trisdešimties sidabri­
    nių grašių baudą, o jeigu privilegija kartais sudegtų, ir dėl
    jos nežinia kur buvimo šiose ribose atsirastų kita karčema,
    pastatyta mums pritarus ir leidus, ar savavališkai, bet kokio
