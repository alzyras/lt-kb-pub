...
- Šaltinyje fiksuotos formos: Saksoniją

## Laikotarpis ir datos
- Šaltinio citatose aiškus laikotarpis ar data nenustatyti.

## Kas tai
- tipas: kunigaikštystė / kraštas
...
- c-001
  santrauka: Minima kaip vieta, į kurią buvo norėta grąžinti karaliaus kariuomenę.
  šaltinis: [[A. Šapoka (red.), Lietuvos istorija (1936 m.)]]
  citata_originali: |
    Po šitos taikos karaliaus
    kariuomenė buvo išsiųsta į Žemaitiją, kur jai buvo tarsi pavestas
    pastatyti Šventosios uostas (prie Palangos), bet iš tikro ji ten
    turėjo laukti patogaus momento įsiveržti į Livoniją. Ten be-
