...
- t-001
  ...
  susije_objektai: 'mentioned_object: [[objektai/zodynas/skitai|skitai]]; mentioned_group: [[objektai/grupes/Lenkai|Lenkai]]; mentioned_group: [[objektai/grupes/Lietuviai|Lietuviai]]; mentioned_place: Podolė'
  pagrindžia:
    - c-001
  ...
  ryšio_targeto_parinkimas: skitai: mention_match, thing, gap=59
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Piotrkovas" parinktas kaip owner_note_path. Targetas "skitai" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
...
- t-002
  ...
  pagrindžia:
    - c-002
  irodymo_stiprumas: 0.00
  saltinio_vieta: 956918-957482; hash=4a8bd3c324aa2488339cc27dc076e6f387cc6df3d335ace348768cfd856ae403; match=exact
  sprendimo_priezastis: auto
  ...
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Piotrkovas" parinktas kaip owner_note_path. Targetas "Lenkai" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.
...
- t-003
  ...
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Piotrkovas" parinktas kaip owner_note_path. Targetas "Jogailaičiai" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, same_sentence_locality.
...
- t-004
  ...
  susije_objektai: 'mentioned_person: [[objektai/asmenys/Augustas|Augustas]]; mentioned_place: Mazovija; mentioned_place: Prūsija; mentioned_object: [[objektai/daiktai/Namas|Namas]]; mentioned_place: Lenkija'
  pagrindžia:
    - c-004
  irodymo_stiprumas: 0.00
  saltinio_vieta: 1202191-1202636; hash=4b6b62b852a8f2b63de8be27133f95160beee1c27580e539fa215664fdf86afb; match=exact
  sprendimo_priezastis: auto
...
- t-005
  ...
  irodymo_stiprumas: 0.00
  saltinio_vieta: 897819-898229; hash=f26790e44663f1e64c330a0ed71ee19b0e19b806ad7e33d4142d23ce51c3fe8e; match=exact
  sprendimo_priezastis: auto
...
- c-002
  ...
  citata_originali: |
    ...
    Kai gandas apie Aleksand-
    J o n a s O lb ra ch ta s iš-
    ro pakėlimą į sostą pasiekė
    re n k a m a s
    L en k ijo s
    Piotrkovą, lenkų seime kilo
    k a ra liu m i
    smarkių
    nesutarimų.
    Daug
    kas manė, kad Aleksandras
    dėl įgimtų gabumų būtų tinkamas lenkų valdovas, daug
    kas būgštavo, kad, karaliaus sostą perdavus kitam ir at­
    siradus dviem valdovams, gali suirti pakankamai ne­
    sustiprėjusi dviejų tautų sąjunga.
  citata_rodoma: ''
  teiginio_tipas: saltinio_teiginys
  statusas: verified
  patikimumo_lygis: vidutinis
...
- c-004
  ...
  pagrindžia:
    - t-004
- c-005
  santrauka: 'Narbutas aiškina, kad 1567 metais vietoj abejotino Gardino seimo iš tikrųjų vyko ilgai posėdžiavęs Lenkijos seimas Piotrkove.'
  šaltinis: Teodoras Narbutas, Lietuvių tautos istorija, t. 1 (1998 m.)
  citata_originali: |
    Po trumpo
  ...
  pagrindžia:
    - t-005
- c-006
  santrauka: 'Piotrkovo seime karalius Žygimantas parengė abiejų tautų žygį, o rudenį su kariuomene išžygiavo iš Vilniaus.'
  šaltinis: Teodoras Narbutas, Lietuvių tautos istorija, t. 1 (1998 m.)
  citata_originali: |
