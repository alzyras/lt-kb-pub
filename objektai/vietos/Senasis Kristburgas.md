---
tipas: vieta
pavadinimas: 'Senasis Kristburgas'
saltiniai:
...
- t-001
  ...
  susije_objektai: 'mentioned_place: Kristburgas; mentioned_author: [[objektai/autoriai/Dusburgas|Dusburgas]]; mentioned_group: [[objektai/grupes/Pamedėnai|Pamedėnai]]; mentioned_object: [[objektai/zodynas/naujakrikščiai|naujakrikščiai]]; mentioned_person: [[objektai/asmenys/Sventopelkas|Sventopelkas]]; mentioned_place: Prūsija; mentioned_place: Viena; llm_object: Senasis Kristburgas'
  semantiniai_rysiai: '[[objektai/grupes/Pamedėnai|Pamedėnai]] gyveno Senasis Kristburgas'
  pagrindžia:
    - c-002
...
- t-002
  ...
  susije_objektai: 'mentioned_group: [[objektai/grupes/Pamedėnai|Pamedėnai]]; llm_object: [[objektai/grupes/Pamedėnai|Pamedėnai]]; mentioned_group: [[objektai/grupes/Kryžiuočių ordinas|Kryžiuočių ordinas]]'
  semantiniai_rysiai: 'Senasis Kristburgas priklausė [[objektai/grupes/Pamedėnai|Pamedėnai]]'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
