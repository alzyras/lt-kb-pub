...
- t-002
  ...
  ryšio_subjekto_parinkimas: Kardinalija: llm_allowed_candidate, place
  ryšio_targeto_parinkimas: Vilnius: llm_allowed_candidate, place
  ryšio_paaiskinimas: Citata tiesiogiai įvardija Kardinaliją kaip Vilniaus namus.
...
- t-003
  ...
  susije_objektai: 'llm_object: Vilnius; mentioned_group: [[objektai/grupes/Radvilos|Radvilos]]; mentioned_place: Vilnius; mentioned_person: [[objektai/asmenys/Tomas (Hertvigo iš Pokarvių sūnus)|Tomas (Hertvigo iš Pokarvių sūnus)]]'
  semantiniai_rysiai: 'Kardinalija priklausė Vilnius'
  pagrindžia:
    - c-001
  irodymo_stiprumas: 0.00
...
- c-001
  santrauka: 'Kardinalija buvo vienas didžiausių Vilniaus namų, statytas kardinolo Jurgio Radvilos lėšomis.'
...
- c-002
  ...
  pagrindžia:
    - t-001
- c-003
  santrauka: 'Radvilų archyve Kardinalijoje buvo saugomi vertingi istorijos šaltiniai.'
  šaltinis: Michał Baliński, Vilniaus miesto istorija (2007 m.)
  citata_originali: |
  ...
  pagrindžia:
    - t-004
- c-004
  santrauka: 'Apie 1601 metus Goštautų ir Filipovo namai, sujungti Albrechto Radvilos laikais, gavo bendrą Kardinalijos pavadinimą.'
  šaltinis: Michał Baliński, Vilniaus miesto istorija (2007 m.)
  citata_originali: |
    Kardinolas Radvila
