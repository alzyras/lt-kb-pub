...
- c-002
  ...
  citata_originali: |
    ...
    Žąsiaukį, padaugavy, patripenty, papinėj, šiandien rūpesny įsidūmoję, atsidūksėja tais žodžiais*.
  citata_rodoma: ""
...
- c-004
  ...
  citata_originali: |
    ...
    mirti, nekaip ne vien šiame pasauly, bet amžinai antrame gyvenime tokiems kraugeriams vergauti,
    todėl šio svieto gyvenimą už nieką turėję, ką patarlės šiandien dar viršiau minavotos stigavoja; ir taip
    sako įsirūpinęs žemaitis: „Diena mano – amžius mano“ arba: „Diena būtoji“, arba: „Ne saulės amžių
    gyvensiu“, arba: „Pūsta^1280 tavęs ar manęs“, arba sako: „Nuo baimės mirusiam bezdalai
    skambina.“
  citata_rodoma: ""
  teiginio_tipas: faktas
  patikimumo_lygis: aukstas
...
- c-005
  ...
  citata_originali: |
    ...
    gyventojams per 10 mylių savo pačias, vaikus su pajudinamuoju lobiu į Padaugavio girias išdanginti,
    o namus tuščius sudeginti.
  citata_rodoma: ""
  teiginio_tipas: faktas
  patikimumo_lygis: aukstas
  patikimumo_saltinis: ai
...
- c-006
  ...
  pagrindžia:
    - t-010
- c-007
  santrauka: 'Bet pirmoji krikščionių bendruomenė Padauguvy buvo silpna, ir pagonys labai dažnai ją išnaikindavo, gyventojus išžudydavo, jų sodybas ir bažnyčias sudegindavo.'
  šaltinis: A. Šapoka (red.), Lietuvos istorija (1936 m.)
  citata_originali: |
