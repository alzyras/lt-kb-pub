...
- t-001
  global_id: t-58678
  teiginys: 'Pamedės valsčius Aliamas 1250 m. minėtas forma Alyem prie Nogato ir siejamas su vėlesniu Štumu.'
  sudarymo_pagrindimas: 'Citata remia glaustą identifikacinį teiginį, pašalinus santrumpas ir nutrūkusią nuorodą.'
  susije_objektai: 'llm_object: Pamedė; mentioned_place: Nogatas; mentioned_place: Pamedė'
  semantiniai_rysiai: 'Aliamas priklausė Pamedė'
  temporaliniai_duomenys: 'įvykio data: 1250 m.'
  temporalinis_paaiskinimas: 'Ši data taikoma teiginyje minimai reikšmei „įvykio data“, o ne visam objekto laikotarpiui.'
  temporalinis_llm_pakomentavimas: 'Citata remia glaustą identifikacinį teiginį, pašalinus santrumpas ir nutrūkusią nuorodą.'
  pagrindžia:
    - c-001
