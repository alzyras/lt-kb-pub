...
- t-002
  teiginys: '13) ėmė žygiuoti Gilgenburgo link.'
  pagrindžia:
    - c-002

## Reikšmingi paminėjimai
- c-001
  santrauka: 'Sąjungininkai paėmė Gilgenburgą ir žygiavo Tannenbergo kryptimi.'
  šaltinis: Zenonas Ivinskis, Lietuvos istorija iki Vytauto Didžiojo mirties (1978 m.)
  citata_originali: |
  ...
  pagrindžia:
    - t-001
- c-002
  santrauka: '13) ėmė žygiuoti Gilgenburgo link.'
  šaltinis: Vytautas Didysis 1350-1430 (1930 m.)
  citata_originali: |
    ```
    — 80 —
    ```
    Tik ant rytojaus (VII. 13) ėmė žygiuoti Gilgenburgo link.
