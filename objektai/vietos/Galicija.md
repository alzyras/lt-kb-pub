...
- t-001
  ...
  sudarymo_pagrindimas: 'Pirminis tekstas nėra faktinis sakinys, bet citata palaiko aiškų faktą.'
  susije_objektai: 'mentioned_group: [[objektai/grupes/Unitai|Unitai]]; mentioned_place: Austrija; llm_object: Austrija; mentioned_group: [[objektai/grupes/Rusai|Rusai]]; mentioned_object: [[objektai/zodynas/unija|unija]]; mentioned_place: Lenkija; mentioned_place: Lietuva; llm_object: Galicija'
  semantiniai_rysiai: 'Galicija priklausė Austrija; [[objektai/grupes/Unitai|Unitai]] gyveno Galicija'
  pagrindžia:
    - c-001
