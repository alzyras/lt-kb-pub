...
Misionierių bažnyčios du bokštai Vorobjovo aprašyme buvo matomi virš Išganytojo kalno.
...
- t-001
  ...
  ryšio_subjekto_parinkimas: "Išganytojo kalnas: owner_note_path, place, gap=0"
  ryšio_targeto_parinkimas: "Išganytojo (Spaso) bažnyčia Vilniuje: mention_match, place, gap=0"
  ryšio_paaiskinimas: "Ryšys sukurtas taisykle \"rule_plain_mention\". Subjektas \"Išganytojo kalnas\" parinktas kaip owner_note_path. Targetas \"Išganytojo (Spaso) bažnyčia Vilniuje\" parinktas kaip mention_match aplink predikatą \"mention\". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality."
...
- id: c-184148
  ...
  puslapiai: "PDF 54"
  indeksas: "Mikalojus Vorobjovas, Vilniaus menas (knyga, 1940 m.), PDF 54."
  citata_originali: |
    Dešimt metų vėliau buvo užbaigta Misionierių bažnyčia, kuri, toliau plė­
    todama šv. Kotrynos architektūrinės išviršės tipą, suteikia jam kuone
