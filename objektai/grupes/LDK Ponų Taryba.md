---
tipas: grupe
pavadinimas: 'LDK Ponų Taryba (institucija, XV a.)'
saltiniai:
...
amziai:
  - 'XV'
---
# LDK Ponų Taryba (institucija, XV a.)

## Santrauka

J. Zaberezinskis ir kiti LDK Ponų Tarybos nariai rėmė Melniko uniją, kuriai Aleksandras ir jo broliai priešinosi dėl dinastinių interesų. Jonas Zaberezinskis, Vaitiekus Taboras, Stanislovas Kiška ir Stanislovas Jonaitis Kęsgaila buvo pašalinti iš LDK Ponų Tarybos. Aleksandro 1492 m. rugpjūčio 6 d. privilegija išplėtė LDK Ponų Tarybos teises ir apribojo didžiojo kunigaikščio sprendimų keitimą be jos žinios.

## Teiginiai

<a id="claim-t-187764"></a>
- t-001
  global_id: t-187764
...
- t-002
  ...
  ryšio_sprendimo_taisykle: rule_plain_mention
  ryšio_subjekto_parinkimas: LDK Ponų Taryba (institucija, XV a.): owner_note_path, group, gap=0
  ryšio_targeto_parinkimas: Ponų taryba (institucija): mention_match, group, gap=4
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "LDK Ponų Taryba (institucija, XV a.)" parinktas kaip owner_note_path. Targetas "Ponų taryba (institucija)" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, target_after_predicate, same_sentence_locality.

<a id="claim-t-187766"></a>
- t-003
  global_id: t-187766
...
- c-001
  santrauka: 'J. Zaberezinskis ir kiti LDK Ponų Tarybos nariai rėmė Melniko uniją, kuriai Aleksandras ir jo broliai priešinosi dėl dinastinių interesų.'
