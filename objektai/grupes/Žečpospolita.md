...
- t-001
  ...
  susije_objektai: 'mentioned_person: [[objektai/asmenys/Pilsudskis|Pilsudskis]]; mentioned_place: Lenkija; mentioned_place: Lietuva'
  pagrindžia:
    - c-001
  ...
  ryšio_subjekto_parinkimas: Žečpospolita: owner_note_path, group, gap=0
  ryšio_targeto_parinkimas: Lenkija: mention_match, place, gap=35
  ryšio_paaiskinimas: Ryšys sukurtas taisykle "rule_plain_mention". Subjektas "Žečpospolita" parinktas kaip owner_note_path. Targetas "Lenkija" parinktas kaip mention_match aplink predikatą "mention". Patikimumą lėmė: owner_before_predicate, single_candidate_target, single_candidate_actor, same_sentence_locality.
