...
- t-002
  ...
  pagrindžia:
    - c-002
- t-003
  teiginys: 'Nors šis įstatymų garantuotas lygiateisiškumas tiesiogiai nelietė nekrikščioniškų konfesijų (judėjų, karaimų ir musulmonų totorių), jų etninės bendruomenės ir religija toleruojamos nuo XIV a.'
  pagrindžia:
    - c-003
...
- c-002
  ...
  pagrindžia:
    - t-002
- c-003
  santrauka: 'Nors šis įstatymų garantuotas lygiateisiškumas tiesiogiai nelietė nekrikščioniškų konfesijų (judėjų, karaimų ir musulmonų totorių), jų etninės bendruomenės ir religija toleruojamos nuo XIV a.'
  šaltinis: Alfonsas Eidintas, Alfredas Bumblauskas, Antanas Kulakauskas, Mindaugas Tamošaitis, Lietuvos istorija (2013 m.)
  citata_originali: |
