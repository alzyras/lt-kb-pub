...
- c-001
  ...
  citata_originali: |
    ...
    sios į savo rankas vokiečių kareivių (paskelbusių revoliuciją) ta-
    rybos. Krašte pairo tvarka; pačiame Vilniuje ėmė organizuotis
    Rusijos pavyzdžiu komunistai; be to, vietiniai lenkai kvietė
    Lenkijos Regentų Tarybą užimti Lietuvą. Tuo tarpu naujoji
    vyriausybė neturėjo net savo saugumui organizuotos ginkluotos
    jėgos.
  citata_rodoma: ''
