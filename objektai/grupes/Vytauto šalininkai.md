...
- t-002
  ...
  semantiniai_rysiai: "Kryžiuočių ordinas užėmė Kernavė (0.93); Kryžiuočių ordinas užėmė Maišiagala (0.93); Kryžiuočių ordinas buvo sąjungininkas su Vytauto šalininkai (0.78); Vytauto šalininkai užėmė Kernavė (0.74); Vytauto šalininkai užėmė Maišiagala (0.74)"
...
- t-001
  ...
  semantiniai_rysiai: "Kryžiuočių ordinas apgulė Trakai (0.94); Vytautas (Lietuvos valdovas, XIV–XV a.) apgulė Trakai (0.94); Vytauto šalininkai apgulė Trakai (0.94); Kryžiuočių ordinas buvo sąjungininkas su Vytautas (Lietuvos valdovas, XIV–XV a.) (0.88)"
