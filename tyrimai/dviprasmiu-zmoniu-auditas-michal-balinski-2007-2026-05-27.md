...
- modelis: unknown
- data_ir_laikas: 2026-05-27 02:22
...
- sprendimas: Nekurti ir nepraturtinti viešo asmens įrašo, kol nebus rasta aiškesnė kūno citata su vardu, pareigomis, ryšiu ar stabiliu vietiniu kontekstu.
...
- problema: Žemo patikimumo asmens kandidatas: vienanarė vardo ar pavardės forma, nepakankamas savarankiškas identifikavimas arba pačiame kandidato kontekste pažymėta tapatybės neaiškumo rizika.
- citata: |
      Juk taip pat nedorai Ordinas elgiasi ir su garbin­
...
- problema: Žemo patikimumo asmens kandidatas: vienanarė vardo ar pavardės forma, nepakankamas savarankiškas identifikavimas arba pačiame kandidato kontekste pažymėta tapatybės neaiškumo rizika.
- citata: |
      Item dominos Arcbiepiscopos et episcopos et Clericos
...
- citata: |
      ...
      paimtos Prūsijoje. Jos sūnus buvo vadinamas Kiršenšteinu,
      ir toji giminė, vėliau gavusi pilietybę, keletą šimtmečių val­
      dė Raudonės pilį.
- sprendimas: Nekurti ir nepraturtinti viešo asmens įrašo, kol nebus rasta aiškesnė kūno citata su vardu, pareigomis, ryšiu ar stabiliu vietiniu kontekstu.
- būsena: palikti kandidatu
...
- problema: Žemo patikimumo asmens kandidatas: vienanarė vardo ar pavardės forma, nepakankamas savarankiškas identifikavimas arba pačiame kandidato kontekste pažymėta tapatybės neaiškumo rizika.
- citata: |
      parduodama juos už 500 sidabrinių rub­
...
- citata: |
      mūsų si­
      dabrą, kurį šiuo metu saugoja Žalinskis, kuris tik yra prie
      mūsų ir paskui kur tik bus saugojamas ir kur tik suras pri­
      klausantį stalo tarnybai ir visą sidabrą, kur yra pas Žalinskį,
      išskyrus bažnytinį, kuris privalo priklausyti Šv. Onos baž­
      nyčiai, pirmiau paminėtai, taipgi ir auksinė karūna, esanti
      pas Žalinskį, kad būtų išduota jų didenybėms.
- sprendimas: Nekurti ir nepraturtinti viešo asmens įrašo, kol nebus rasta aiškesnė kūno citata su vardu, pareigomis, ryšiu ar stabiliu vietiniu kontekstu.
- būsena: palikti kandidatu
...
- citata: |
      ...
      vėliau ir kur kitur ir pas ką tik ras,
- sprendimas: Nekurti ir nepraturtinti viešo asmens įrašo, kol nebus rasta aiškesnė kūno citata su vardu, pareigomis, ryšiu ar stabiliu vietiniu kontekstu.
- būsena: palikti kandidatu
...
- citata: |
      Jų Malonybės
      nuolankus broliai ir bičiuliai
      Ą1b. BaranovskisEustachijus Valavičius
      vyskupas ir Vilniaus ponas
      pakancleris Mikalojus Manivydas
      Dorohostaiskis,
      did. antsp.
- sprendimas: Nekurti ir nepraturtinti viešo asmens įrašo, kol nebus rasta aiškesnė kūno citata su vardu, pareigomis, ryšiu ar stabiliu vietiniu kontekstu.
- būsena: palikti kandidatu
...
- citata: |
      kai buvo iš anksto pasiųstas su pinigais, kad
      443
      ...
      Plockiui sumokėti skolą iš lietuviškų monetų,
- sprendimas: Nekurti ir nepraturtinti viešo asmens įrašo, kol nebus rasta aiškesnė kūno citata su vardu, pareigomis, ryšiu ar stabiliu vietiniu kontekstu.
- būsena: palikti kandidatu
...
- problema: Žemo patikimumo asmens kandidatas: vienanarė vardo ar pavardės forma, nepakankamas savarankiškas identifikavimas arba pačiame kandidato kontekste pažymėta tapatybės neaiškumo rizika.
- citata: |
      Taip pat buvo trys sidabriniai dubenys
      442
      ...
      [nuo liepos 10 dienos iki rugpjūčio 18 dienos], nuo pustre­
...
- sprendimas: Nenaudoti kaip `statusas: patvirtinta` teiginio pagrindo; reikalinga rankinė šaltinio peržiūra arba švaresnė citata.
...
- problema: Citatos priskyrimas pažymėtas `priskyrimo_pagrindas: needs_review`; tekstas OCR arba maketo požiūriu pažeistas, todėl netinka patvirtintam teiginiui.
- citata: |
      Mikalojus Albrechtas Mikalojus Tolvaišas
      Radvila Radvila Žemaičių kaštelionas
      Naugarduko LDK didysis R... seniūnas
      vaivada maršalka
      Leonas Sapiega Teodoras Skuminas,
      pakancleris savo LDK iždininkas
      ranka savo ranka
- sprendimas: Nenaudoti kaip `statusas: patvirtinta` teiginio pagrindo; reikalinga rankinė šaltinio peržiūra arba švaresnė citata.
- būsena: reikia patikrinti
...
- citata: |
      jo laikais Vilniuje jau klestėjo keli garsūs gydytojai,
      26
      Manding iki šiol nežinomuose, ypač
      retuose mano turimuose Vilniaus
      diecezijos sinodo statutuose iš Žy­
      gimanto Senojo laiku, paskelbtuose
      Vilniaus vyskupo Jono iš Lietuvos
      kunigaikščių, yra nurodymai klebo­
      nams, kad visur prie bažnyčių sta­
      tytų mokyklas ir namus besimokan­
      čiam jaunimui gyventi ir kad jose
      mokytų naudingų mokslų, gerų pa­
      pročių ir pagrindinių katalikų tikė­
      jimo dorybių, kad evangelija ir šv.
      Povilo laiškai jaunimui būtų dėsto­
      mi lietuvių ir lenkų kalbomis.
      ## Puslapis 288

      pavyzdžiui, Andrius de Valentinis, dailės ir medicinos dak­
      taras, karaliaus ir karalienės Bonos rūmų gydytojas, Vilniaus
      dekanas ir kanauninkas.
- sprendimas: Perinkaruoti iš darbo šaltinio kūno teksto prieš kuriant arba pildant asmens įrašą.
- būsena: reikia patikrinti
...
- sprendimas: Perinkaruoti patvirtinamą kūno citatą; iki tol nenaudoti viešo teiginio pagrindui.
- būsena: reikia patikrinti
...
- citata: |
      ...
      dekretu - 1667
- sprendimas: Nenaudoti kaip vienintelio finalaus asmens įrašo pagrindo be papildomos kūno citatos arba rankinio patvirtinimo.
- būsena: reikia patikrinti
...
- citata: |
      16. Baltramiejus Cinakis - 1680
- sprendimas: Palikti kandidatu; viešam įrašui reikia stipresnio identifikavimo.
- būsena: palikti kandidatu
...
- sprendimas: Rankiniu būdu patikrinti platesnį sąrašo kontekstą.
- būsena: reikia patikrinti
...
- sprendimas: Nelaikyti dengtu; reikia sukurti atskirą inkaruotą kūno citatą prieš viešą įrašą.
- būsena: reikia patikrinti
