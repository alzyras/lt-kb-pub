---
tipas: tyrimas
pavadinimas: 'Įrodymų ledgerio suvestinė - Lietuvos metraštis, Bychovco kronika (1971 m.)'
saltiniai:
...
- viešasis šaltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
...
- authors: `verified 402`, `quote_not_found 2`, `no_quote 1`, `ambiguous 0`, `weak_context 2`
- customs: `verified 146`, `quote_not_found 0`, `no_quote 20`, `ambiguous 0`, `weak_context 0`
- events: `verified 231`, `quote_not_found 167`, `no_quote 5`, `ambiguous 0`, `weak_context 0`
- groups: `verified 562`, `quote_not_found 18`, `no_quote 5`, `ambiguous 16`, `weak_context 10`
- items: `verified 150`, `quote_not_found 0`, `no_quote 18`, `ambiguous 0`, `weak_context 0`
- people: `verified 1512`, `quote_not_found 88`, `no_quote 6`, `ambiguous 13`, `weak_context 0`
- places: `verified 1221`, `quote_not_found 74`, `no_quote 2`, `ambiguous 2`, `weak_context 0`
- sayings: `verified 84`, `quote_not_found 7`, `no_quote 0`, `ambiguous 0`, `weak_context 0`
- sources: `verified 214`, `quote_not_found 12`, `no_quote 8`, `ambiguous 0`, `weak_context 2`
- vocabulary: `candidate_ledger_index` faile atskirų būsenų įrašų šiai kategorijai nerasta

## Atrankos pastabos

- Suvestinė orientuota į aukšto signalo, mechaniškai patvirtintų citatų branduolį ir į tas vietas, kurios viešose pastabose greičiausiai taps naujais `t-*` ir `c-*` mazgais.
- `quote_not_found`, `no_quote`, `ambiguous` ir `weak_context` eilutės laikytos atradimo pėdsakais, o ne galutine padengtimi; jos negali blokuoti vėlesnės kūno citatos panaudojimo.
- Daugiausia nebaigtų arba konfliktiškų sankaupų liko `events`, `groups` ir `people` kategorijose, kur daug paralelinių siužetų, genealogijų ir komentarinių išnašų.
...
- kategorija: saltinis
- kandidatas: Lietuvos metraštis, Bychovco kronika (1971 m.)
- potencialus_teiginys: 1971 m. Vilniuje išleistas leidinys vadinasi „Lietuvos metraštis, Bychovco kronika“, o vertimą, įvadą ir paaiškinimus parašė Rimantas Jasas.
- public_note: objektai/saltiniai/Lietuvos metraštis, Bychovco kronika (1971 m.).md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: pradžios puslapiai; match: whitespace_regex
- santrauka: Tiesioginis titulinių puslapių blokas pagrindžia leidinio pavadinimą, leidimo vietą ir rengėją.
- pagrindzia:
- pastaba: Tinka viešo šaltinio lapo bibliografinių duomenų stiprinimui.
  citata_originali: |
    LIETUVOS
    METRAŠTIS
    Bychovco kronika
...
## source-pavadinimas-ir-praminimas-001

- status: unused
- claim_role: new_claim
- kategorija: saltinis
- kandidatas: Lietuvos metraštis, Bychovco kronika (1971 m.)
- potencialus_teiginys: Leidinio įvadas teigia, kad „Lietuvos metraštis“ nėra autentiškas rankraščio pavadinimas, o vardas „Bychovco kronika“ XIX a. prigijo pagal Aleksandrą Bychovcą.
- public_note: objektai/saltiniai/Lietuvos metraštis, Bychovco kronika (1971 m.).md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: įvadas; match: exact
- santrauka: Viena citata vienu metu apibrėžia neautentišką leidinio antraštę, praminto pavadinimo kilmę ir lietuviškos antraštės motyvaciją.
- pagrindzia:
- pastaba: Tai pagrindinis aukšto signalo citatos blokas viešo šaltinio pastabai apie pavadinimo kilmę.
  citata_originali: |
...
## source-transkripcija-001

- status: unused
- claim_role: new_claim
- kategorija: zodynas
- kandidatas: transkripcija
- potencialus_teiginys: Leidinio įvadas teigia, kad rastasis Bychovco kronikos rankraštis buvo ne vertimas, o kirilica rašyto teksto transkripcija lotyniškai lenkiškais rašmenimis ir vėlesnis nuorašas iš blogai išlikusios kopijos.
- public_note: objektai/zodynas/transkripcija.md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: įvadas; match: exact
- santrauka: Citata tiksliai atskiria vertimą nuo transkripcijos ir iš karto apibūdina rankraščio tekstologinę būklę.
- pagrindzia:
- pastaba: Tinkama tiek žodyno, tiek viešo šaltinio lapo tekstologinei daliai.
  citata_originali: |
    lenkiškai
    ...
    paties autoriaus rašytas tekstas

## authors-strijkovskis-variantas-001

- status: unused
- claim_role: new_claim
- kategorija: autorius
- kandidatas: Motiejus Strijkovskis
...
## events-legendine-riba-001

- status: unused
- claim_role: new_claim
- kategorija: ivykis
- kandidatas: Kęstučio ir Algirdo perversmas prieš Jaunutį
- potencialus_teiginys: Leidinio įvadas legendine laiko pradinę Platesniojo sąvado dalį iki 1345 m. Kęstučio ir Algirdo sąmokslo prieš Jaunutį.
- public_note: objektai/ivykiai/Kęstučio ir Algirdo perversmas prieš Jaunutį.md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: chunk_0001; match: exact
- santrauka: Redakcinis įvadas aiškiai pažymi tekstinę ribą tarp legendinės dalies ir vėlesnio istorinės tradicijos sluoksnio.
- pagrindzia:
- pastaba: Tai svarbi citata ne tiek pačiam 1345 m. įvykiui, kiek jo vaidmeniui metraščio sandaroje ir tekstologijoje.
  citata_originali: |
...
## events-algirdo-zygis-i-maskva-001

- status: unused
- claim_role: new_claim
- kategorija: ivykis
- kandidatas: Algirdo žygis į Maskvą
- potencialus_teiginys: Kronika pasakoja, kad Algirdas, atsakydamas į Dimitrijaus Ivanovičiaus karo paskelbimą, pažadėjo per Velykas atvykti į Maskvą ir atrėmė savo žygį simbolizuojančią ietį į miesto sieną.
- public_note: objektai/ivykiai/Algirdo žygis į Maskvą.md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: chunk_0004; match: exact
- santrauka: Aukšto signalo pasakojimo blokas su karo paskelbimu, Algirdo atsaku ir pažadu pasirodyti Maskvoje per Velykas.
- pagrindzia:
- pastaba: Dėl kronikos pobūdžio viešame teiginyje būtinas priskyrimas pačiam šaltiniui.
  citata_originali: |
    ...
    aš, jei dievas duos, būsiu pas jį per Velykas

## customs-pajautos-garbinimas-001

- status: unused
- claim_role: new_claim
- kategorija: paprotys
- kandidatas: Pajautos atminimo stabo ir liepų garbinimas
- potencialus_teiginys: Kronika pasakoja, kad Kukovaitis Pajautos atminimui padirbo stabą ties Žaslių ežeru, o Pajauta ir toje vietoje išaugusios liepos buvo garbinamos.
- public_note: objektai/paprociai/Pajautos atminimo stabo ir liepų garbinimas.md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: chunk_0003; match: exact
- santrauka: Stiprus legendinio religinio papročio blokas su stabo pagaminimu, dievinimu ir vėlesniu liepų garbinimu.
- pagrindzia:
- pastaba: Dėl religinio ir legendinio pobūdžio viešame teiginyje būtinas aiškus priskyrimas kronikos pasakojimui.
  citata_originali: |
...
## sayings-suns-kfauju-001

- status: unused
- claim_role: new_claim
- kategorija: posakis
- kandidatas: šuns kfauju
- potencialus_teiginys: Leidinio įvadas pažymi, kad Bychovco kronikos tekste valstiečiai vadinami „šuns kfauju“, o formulė „mužikus — šuns kraują — iškelti“ vartojama kaip didikų baimės ir priešiškumo vaizdinys.
- public_note: objektai/posakiai/šuns kfauju.md
- saltinis: Lietuvos metraštis, Bychovco kronika (1971 m.)
- vieta_saltinyje: įvadas; match: exact
- santrauka: Aukšto signalo socialinio priešiškumo ir luominio žodyno citata, svarbi šaltinio perspektyvos auditui.
- pagrindzia:
- pastaba: Viešame teiginyje būtina išlaikyti priskyrimą šaltinio vaizdiniui, o ne neutralizuoti šį apibūdinimą.
  citata_originali: |
...
- `events` kategorijoje daug nebaigtų kandidatų susiję su ilgais karo pasakojimais ir kelių citatų tais pačiais siužetais dubliavimu; viešame integravime reikės išlaikyti daugiausia dvi labai artimas vieno teiginio citatas.
