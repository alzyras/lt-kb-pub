...
ex={'schemaVersion':'ltkb-exhibition/v1','exhibitionId':'ex-lietuvos-ir-atr-valdovai','slug':'parodos/lietuvos-ir-atr-valdovai','title':'LDK ir ATR valdovai','subtitle':'Nuo Mindaugo iki Stanislovo Augusto Poniatovskio','description':'33 valdovų istorijos nuo Lietuvos karalystės iki Respublikos padalijimų. Nuo ankstyvosios Lietuvos kūrimosi ir dinastinių kovų iki renkamos Respublikos monarchijos, Apšvietos reformų ir 1795 metų. Atvaizdai, valdymo datos ir pasakojimai kviečia pažinti žmones, kurių sprendimai keitė valstybę.','layout':'chronological','status':'published','noindex':False,'heroMediaId':rulers[-1]['media']['mediaId'],'sections':[]}
