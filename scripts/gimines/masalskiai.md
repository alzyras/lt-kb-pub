...
Atnaujinta: 2026-09-21. Eilė: 28. Etapas: 2.

**Būsena:** Suplanuota; surinkti vietiniai kandidatai.

**Tyrimo kryptys:** Vilniaus vyskupija, Verkiai, švietimas ir politiniai konfliktai. Tai paieškos užduotys; konkretaus žmogaus nuosavybę, laikotarpį ir giminystę būtina patvirtinti.

[Visų giminių planas](README.md) · [Vienodos rengimo taisyklės](metodika.md)

## Vietinių asmenų puslapių inventorius

Rasta **1** failų pagal vardų paiešką. Tai nėra tiek pat unikalių ar patvirtintų giminės narių. Įrašai be teiginių gali būti tik pradinės kortelės. Medijų skaičius nereiškia portretų skaičiaus; parodai reikia atskiros vaizdo patikros.

| Puslapis | Teiginių metaduomenys | Medijų metaduomenys | Parinkto atvaizdo ID | Genealogijos būsena |
|---|---:|---:|---|---|
| [Ignotas Masalskis](<../../objektai/asmenys/Ignotas Masalskis.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
