...
Atnaujinta: 2026-09-21. Eilė: 14. Etapas: 2.

**Būsena:** Suplanuota; surinkti vietiniai kandidatai.

**Tyrimo kryptys:** Oršos mūšis, Voluinė, stačiatikių mecenatystė ir knygų leidyba. Tai paieškos užduotys; konkretaus žmogaus nuosavybę, laikotarpį ir giminystę būtina patvirtinti.

[Visų giminių planas](README.md) · [Vienodos rengimo taisyklės](metodika.md)

## Vietinių asmenų puslapių inventorius

Rasta **6** failų pagal vardų paiešką. Tai nėra tiek pat unikalių ar patvirtintų giminės narių. Įrašai be teiginių gali būti tik pradinės kortelės. Medijų skaičius nereiškia portretų skaičiaus; parodai reikia atskiros vaizdo patikros.

| Puslapis | Teiginių metaduomenys | Medijų metaduomenys | Parinkto atvaizdo ID | Genealogijos būsena |
|---|---:|---:|---|---|
| [Elžbieta (Ostrogo kunigaikštytė)](<../../objektai/asmenys/Elžbieta (Ostrogo kunigaikštytė).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Feodoras (Ostrogo kunigaikštis)](<../../objektai/asmenys/Feodoras (Ostrogo kunigaikštis).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Fiodoras Ostrogiškis](<../../objektai/asmenys/Fiodoras Ostrogiškis.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Konstantinas Ivanovičius Ostrogiškis](<../../objektai/asmenys/Konstantinas Ivanovičius Ostrogiškis.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Konstantinas Ostrogiškis](<../../objektai/asmenys/Konstantinas Ostrogiškis.md>) | 6 | 0 | — | tikrinti tapatybę ir šaką |
| [Michailas Ivanovičius Ostrogiškis](<../../objektai/asmenys/Michailas Ivanovičius Ostrogiškis.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
