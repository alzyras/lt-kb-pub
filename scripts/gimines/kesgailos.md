...
Atnaujinta: 2026-09-21. Eilė: 9. Etapas: 1.

**Būsena:** Suplanuota; surinkti vietiniai kandidatai.

**Tyrimo kryptys:** Žemaitijos seniūnai, Kražiai; valdų ir pareigybių geografija. Tai paieškos užduotys; konkretaus žmogaus nuosavybę, laikotarpį ir giminystę būtina patvirtinti.

[Visų giminių planas](README.md) · [Vienodos rengimo taisyklės](metodika.md)

## Vietinių asmenų puslapių inventorius

Rasta **5** failų pagal vardų paiešką. Tai nėra tiek pat unikalių ar patvirtintų giminės narių. Įrašai be teiginių gali būti tik pradinės kortelės. Medijų skaičius nereiškia portretų skaičiaus; parodai reikia atskiros vaizdo patikros.

| Puslapis | Teiginių metaduomenys | Medijų metaduomenys | Parinkto atvaizdo ID | Genealogijos būsena |
|---|---:|---:|---|---|
| [Jonas Lenartaitis Kęsgaila](<../../objektai/asmenys/Jonas Lenartaitis Kęsgaila.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Kęsgaila](<../../objektai/asmenys/Kęsgaila.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Mykolas Kęsgaila](<../../objektai/asmenys/Mykolas Kęsgaila.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Mykolas Valimantaitis Kęsgaila](<../../objektai/asmenys/Mykolas Valimantaitis Kęsgaila.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Stanislovas Stanislovaitis Kęsgaila (m. 1532)](<../../objektai/asmenys/Stanislovas Stanislovaitis Kęsgaila (m. 1532).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
