...
Atnaujinta: 2026-09-21. Eilė: 15. Etapas: 2.

**Būsena:** Suplanuota; surinkti vietiniai kandidatai.

**Tyrimo kryptys:** Kunigaikščių šakos, karinės ir politinės karjeros, santuokos. Tai paieškos užduotys; konkretaus žmogaus nuosavybę, laikotarpį ir giminystę būtina patvirtinti.

[Visų giminių planas](README.md) · [Vienodos rengimo taisyklės](metodika.md)

## Vietinių asmenų puslapių inventorius

Rasta **3** failų pagal vardų paiešką. Tai nėra tiek pat unikalių ar patvirtintų giminės narių. Įrašai be teiginių gali būti tik pradinės kortelės. Medijų skaičius nereiškia portretų skaičiaus; parodai reikia atskiros vaizdo patikros.

| Puslapis | Teiginių metaduomenys | Medijų metaduomenys | Parinkto atvaizdo ID | Genealogijos būsena |
|---|---:|---:|---|---|
| [Mykolas Kaributas Višniaveckis](<../../objektai/asmenys/Mykolas Kaributas Višniaveckis.md>) | tikrinti | 1 | m-291df95ba98f1b6627d95086 | tikrinti tapatybę ir šaką |
| [Ona Višnioveckaitė (Mikalojaus Sapiegos žmona)](<../../objektai/asmenys/Ona Višnioveckaitė (Mikalojaus Sapiegos žmona).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Višnioveckis](<../../objektai/asmenys/Višnioveckis.md>) | tikrinti | 1 | — | tikrinti tapatybę ir šaką |
