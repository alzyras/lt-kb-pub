...
Atnaujinta: 2026-09-21. Eilė: 10. Etapas: 1.

**Būsena:** Suplanuota; surinkti vietiniai kandidatai.

**Tyrimo kryptys:** Giminės pradžia, Horodlė, ryšys su Radvilomis; kilmės versijos. Tai paieškos užduotys; konkretaus žmogaus nuosavybę, laikotarpį ir giminystę būtina patvirtinti.

[Visų giminių planas](README.md) · [Vienodos rengimo taisyklės](metodika.md)

## Vietinių asmenų puslapių inventorius

Rasta **7** failų pagal vardų paiešką. Tai nėra tiek pat unikalių ar patvirtintų giminės narių. Įrašai be teiginių gali būti tik pradinės kortelės. Medijų skaičius nereiškia portretų skaičiaus; parodai reikia atskiros vaizdo patikros.

| Puslapis | Teiginių metaduomenys | Medijų metaduomenys | Parinkto atvaizdo ID | Genealogijos būsena |
|---|---:|---:|---|---|
| [Astikas](<../../objektai/asmenys/Astikas.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Aštikas](<../../objektai/asmenys/Aštikas.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Grigalius Astikas](<../../objektai/asmenys/Grigalius Astikas.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Jurgis Astikaitis](<../../objektai/asmenys/Jurgis Astikaitis.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Jurgis Astikas](<../../objektai/asmenys/Jurgis Astikas.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Ona Scholastika Chodkevičiūtė](<../../objektai/asmenys/Ona Scholastika Chodkevičiūtė.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Stasys Raštikis](<../../objektai/asmenys/Stasys Raštikis.md>) | 1 | 0 | — | tikrinti tapatybę ir šaką |
