...
Atnaujinta: 2026-09-21. Eilė: 46. Etapas: 3.

**Būsena:** Suplanuota; surinkti vietiniai kandidatai.

**Tyrimo kryptys:** Rokiškis ir valdos, pareigūnai, kolekcijos; pavardės variantai. Tai paieškos užduotys; konkretaus žmogaus nuosavybę, laikotarpį ir giminystę būtina patvirtinti.

[Visų giminių planas](README.md) · [Vienodos rengimo taisyklės](metodika.md)

## Vietinių asmenų puslapių inventorius

Rasta **4** failų pagal vardų paiešką. Tai nėra tiek pat unikalių ar patvirtintų giminės narių. Įrašai be teiginių gali būti tik pradinės kortelės. Medijų skaičius nereiškia portretų skaičiaus; parodai reikia atskiros vaizdo patikros.

| Puslapis | Teiginių metaduomenys | Medijų metaduomenys | Parinkto atvaizdo ID | Genealogijos būsena |
|---|---:|---:|---|---|
| [Aleksandras Pšezdieckis (Livonijos kaštelionas, XVIII a.)](<../../objektai/asmenys/Aleksandras Pšezdieckis (Livonijos kaštelionas, XVIII a.).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Antanas Tadas Pšezdeckis (LDK referendorius, XVIII a.)](<../../objektai/asmenys/Antanas Tadas Pšezdeckis (LDK referendorius, XVIII a.).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Elena Pšezdzeckaitė](<../../objektai/asmenys/Elena Pšezdzeckaitė.md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
| [Stanislovas Pšezdeckis (Smolensko pilies teisėjas, XVIII a.)](<../../objektai/asmenys/Stanislovas Pšezdeckis (Smolensko pilies teisėjas, XVIII a.).md>) | tikrinti | 0 | — | tikrinti tapatybę ir šaką |
