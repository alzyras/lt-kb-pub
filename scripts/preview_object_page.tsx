...
const server = http.createServer(async (req, res) => {
  ...
  if (route === "" || route.startsWith("parodos/")) {
    ...
    res.setHeader("Content-Type", "text/html; charset=utf-8")
    res.setHeader("Cache-Control", "no-store")
    return res.end(`<!doctype html><html lang="lt" saved-theme="${url.searchParams.get("theme") === "dark" ? "dark" : "light"}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>${css}</style></head><body data-slug="${route || "index"}">${previewBody(props,components[route ? 9 : 8](props))}<script type="module">window.addCleanup=()=>{};${scripts}\n${spa}</script></body></html>`)
  }
  if (
    ...
    res.setHeader("Cache-Control", "no-store")
    return res.end(
      `<!doctype html><html lang="lt" saved-theme="${url.searchParams.get("theme") === "dark" ? "dark" : "light"}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${route}</title><style>${css}</style><script>window.addCleanup=()=>{};</script></head><body data-slug="${route}/index">${previewBody(props, body)}<script type="module">${scripts}\n${spa}</script></body></html>`,
    )
  }
  ...
  if (otherObject && route !== slug && fs.existsSync(otherObject.filePath)) {
    ...
    res.setHeader("Content-Type", "text/html; charset=utf-8")
    res.setHeader("Cache-Control", "no-store")
    return res.end(`<!doctype html><html lang="lt" saved-theme="${url.searchParams.get("theme") === "dark" ? "dark" : "light"}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>${css}</style></head><body data-slug="${route}">${previewBody(props,components[0](props))}<script type="module">window.addCleanup=()=>{};${scripts}\n${spa}</script></body></html>`)
  }
  if (route === slug || route.startsWith(`${slug}/`)) {
    ...
    res.setHeader("Cache-Control", "no-store")
    return res.end(
      `<!doctype html><html lang="lt" saved-theme="${url.searchParams.get("theme") === "dark" ? "dark" : "light"}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${String(fm.title).replaceAll("<", "&lt;")}</title><style>${css}</style><script>window.addCleanup=()=>{};</script></head><body data-slug="${route}">${previewBody(props, Component(props))}<script type="module">${scripts}\n${spa}</script></body></html>`,
    )
  }
